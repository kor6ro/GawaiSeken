...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium">Perbarui Password</h2>
            <p class="mt-1 text-sm text-muted-foreground">Pastikan akun Anda menggunakan kata sandi acak yang panjang untuk tetap aman.</p>
        </header>
