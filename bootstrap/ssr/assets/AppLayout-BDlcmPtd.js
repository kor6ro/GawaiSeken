...
import { Home, LayoutDashboard, MessageSquare, Search, SlidersHorizontal, ShoppingCart, Sun, Moon, ShoppingBag, User, Store, LogOut, ChevronDown, Menu, X, Settings, Cpu, HardDrive, ArrowUpDown } from "lucide-vue-next";
      ...
      if (unref(auth).user) {
        ...
        if (unref(auth).user.role === "admin") {
          _push(ssrRenderComponent(unref(Link), {
            ...
            class: [[
              _ctx.route().current("admin.*") ? "text-primary" : "text-muted-foreground hover:bg-accent hover:text-foreground"
            ], "group relative rounded-xl p-2 transition-all duration-100"],
            title: "Admin Panel"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          content: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (unref(auth).user.role === "admin") {
                _push2(ssrRenderComponent(_sfc_main$1, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(LayoutDashboard), { class: "mr-2 inline h-4 w-4 text-primary" }, null, _parent3, _scopeId2));
                      _push3(` Admin Panel `);
                    } else {
                      return [
                        createVNode(unref(LayoutDashboard), { class: "mr-2 inline h-4 w-4 text-primary" }),
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(ShoppingBag), { class: "mr-2 inline h-4 w-4" }, null, _parent3, _scopeId2));
                    _push3(` Pesanan Saya `);
                  } else {
                    return [
                      createVNode(unref(ShoppingBag), { class: "mr-2 inline h-4 w-4" }),
