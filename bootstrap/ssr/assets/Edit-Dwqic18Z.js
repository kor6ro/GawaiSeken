...
import _sfc_main$4 from "./DeleteUserForm-h7DyrKoJ.js";
import _sfc_main$3 from "./UpdatePasswordForm-KTlCqqRZ.js";
import _sfc_main$2 from "./UpdateProfileInformationForm-DsVEUwX6.js";
import { _ as _sfc_main$5 } from "./BackButton-DqmVU1VH.js";
...
import "./AddressForm-BfSsHc8g.js";
import "axios";
const _sfc_main = {
  __name: "Edit",
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { fallbackRoute: "buyer.dashboard" }, null, _parent2, _scopeId));
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground"${_scopeId}>Pengaturan Akun</h2></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-3" }, [
                createVNode(_sfc_main$5, { fallbackRoute: "buyer.dashboard" }),
