import { ref, watch, shallowRef, resolveComponent, withCtx, unref, createVNode, createTextVNode, createBlock, openBlock, Fragment, toDisplayString, createCommentVNode, resolveDynamicComponent, isRef, renderList, withModifiers, withDirectives, vModelText, vShow, Transition, vModelSelect, useSSRContext } from "vue";
...
import { _ as _sfc_main$b } from "./BackButton-DqmVU1VH.js";
import { LayoutDashboard, ShoppingBag, Tag, Settings, CreditCard, Clock, Package, Plus, CheckCircle, Image, Edit3, Trash2, Users, CheckCircle2, AlertTriangle, ChevronUp, ChevronDown, XCircle, Calendar, X, Truck } from "lucide-vue-next";
...
import { _ as _sfc_main$6 } from "./InputLabel-D_lYO37a.js";
...
import { _ as _sfc_main$8 } from "./AddressForm-BfSsHc8g.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center gap-3" data-v-fe8e3103${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$b, { fallbackRoute: "home" }, null, _parent2, _scopeId));
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground" data-v-fe8e3103${_scopeId}>Seller Dashboard</h2></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-3" }, [
                createVNode(_sfc_main$b, { fallbackRoute: "home" }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="py-12" data-v-fe8e3103${_scopeId}><div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8" data-v-fe8e3103${_scopeId}><div class="mx-auto flex max-w-2xl space-x-1 rounded-xl bg-muted p-1 sm:mx-0" data-v-fe8e3103${_scopeId}><button class="${ssrRenderClass([tab.value === "overview" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground", "flex flex-1 items-center justify-center gap-1 rounded-lg px-2 py-2 text-xs font-bold transition-all duration-200 sm:gap-2 sm:px-4 sm:py-2.5 sm:text-sm"])}" data-v-fe8e3103${_scopeId}>`);
            ...
            _push2(` Pengaturan </button></div><div class="transition-all duration-300" style="${ssrRenderStyle(tab.value === "overview" ? null : { display: "none" })}" data-v-fe8e3103${_scopeId}><div class="mb-6 border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8" data-v-fe8e3103${_scopeId}><header class="mb-6" data-v-fe8e3103${_scopeId}><h2 class="text-lg font-medium" data-v-fe8e3103${_scopeId}>Statistik Toko</h2><p class="mt-1 text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}> Ringkasan performa penjualan Anda saat ini. </p></header><div class="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4" data-v-fe8e3103${_scopeId}><div class="rounded-2xl border border-border bg-muted p-4 transition-colors sm:p-6" data-v-fe8e3103${_scopeId}><div class="mb-2 flex items-center justify-between" data-v-fe8e3103${_scopeId}><p class="text-[10px] font-black uppercase tracking-wider text-muted-foreground sm:text-xs" data-v-fe8e3103${_scopeId}> Total Pendapatan </p>`);
            _push2(ssrRenderComponent(unref(CreditCard), { class: "h-4 w-4 text-indigo-500 sm:h-5 sm:w-5" }, null, _parent2, _scopeId));
            _push2(`</div><p class="mt-2 text-lg font-black text-indigo-600 dark:text-indigo-400 sm:text-2xl truncate" data-v-fe8e3103${_scopeId}> Rp ${ssrInterpolate(new Intl.NumberFormat("id-ID").format(__props.totalRevenue || 0))}</p></div><div class="rounded-2xl border border-border bg-muted p-4 transition-colors cursor-pointer hover:bg-accent/50 hover:border-amber-500/30 sm:p-6" data-v-fe8e3103${_scopeId}><div class="mb-2 flex items-center justify-between" data-v-fe8e3103${_scopeId}><p class="text-[10px] font-black uppercase tracking-wider text-muted-foreground sm:text-xs" data-v-fe8e3103${_scopeId}> Pesanan Aktif </p>`);
            _push2(ssrRenderComponent(unref(Clock), { class: "h-4 w-4 text-amber-500 sm:h-5 sm:w-5" }, null, _parent2, _scopeId));
            _push2(`</div><p class="mt-2 text-xl font-black text-amber-600 dark:text-amber-400 sm:text-3xl" data-v-fe8e3103${_scopeId}>${ssrInterpolate(__props.pendingOrders || 0)}</p></div><div class="rounded-2xl border border-border bg-muted p-4 transition-colors cursor-pointer hover:bg-accent/50 hover:border-emerald-500/30 sm:p-6" data-v-fe8e3103${_scopeId}><div class="mb-2 flex items-center justify-between" data-v-fe8e3103${_scopeId}><p class="text-[10px] font-black uppercase tracking-wider text-muted-foreground sm:text-xs" data-v-fe8e3103${_scopeId}> Total Terjual </p>`);
            _push2(ssrRenderComponent(unref(ShoppingBag), { class: "h-4 w-4 text-emerald-500 sm:h-5 sm:w-5" }, null, _parent2, _scopeId));
            _push2(`</div><p class="mt-2 text-xl font-black text-emerald-600 dark:text-emerald-400 sm:text-3xl" data-v-fe8e3103${_scopeId}>${ssrInterpolate(__props.transactionsCount || 0)}</p></div><div class="rounded-2xl border border-border bg-muted p-4 transition-colors sm:p-6" data-v-fe8e3103${_scopeId}><div class="mb-2 flex items-center justify-between" data-v-fe8e3103${_scopeId}><p class="text-[10px] font-black uppercase tracking-wider text-muted-foreground sm:text-xs" data-v-fe8e3103${_scopeId}> Produk Aktif </p>`);
            _push2(ssrRenderComponent(unref(Package), { class: "h-4 w-4 text-blue-500 sm:h-5 sm:w-5" }, null, _parent2, _scopeId));
            _push2(`</div><p class="mt-2 text-xl font-black text-blue-600 dark:text-blue-400 sm:text-3xl" data-v-fe8e3103${_scopeId}>${ssrInterpolate(__props.productsCount || 0)}</p></div></div></div><div class="border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8" data-v-fe8e3103${_scopeId}><div class="mb-6 flex items-center justify-between" data-v-fe8e3103${_scopeId}><div data-v-fe8e3103${_scopeId}><h3 class="text-lg font-bold" data-v-fe8e3103${_scopeId}>Produk Saya</h3><p class="text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}>Kelola barang dagangan Anda.</p></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-fe8e3103${_scopeId2}>Tambah Produk</span>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="easy-table-wrapper hidden md:block" data-v-fe8e3103${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EasyDataTable, {
              ...
              "item-title": withCtx(({ title, images, category }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-4 py-2" data-v-fe8e3103${_scopeId2}><div class="h-12 w-12 flex-shrink-0 overflow-hidden rounded-md border border-border bg-muted" data-v-fe8e3103${_scopeId2}>`);
                  if (images && images.length > 0) {
                    _push3(`<img${ssrRenderAttr("src", `/storage/${images[0].image_path}`)} loading="lazy" class="h-full w-full object-cover" data-v-fe8e3103${_scopeId2}>`);
                  } else {
                    _push3(`<div class="flex h-full w-full items-center justify-center text-muted-foreground" data-v-fe8e3103${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Image), { class: "h-6 w-6" }, null, _parent3, _scopeId2));
                    _push3(`</div>`);
                  }
                  _push3(`</div><div class="min-w-0" data-v-fe8e3103${_scopeId2}><div class="line-clamp-1 text-base font-bold text-foreground" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(title)}</div><div class="text-xs text-muted-foreground/80" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(category == null ? void 0 : category.name)}</div></div></div>`);
                } else {
                  return [
              ...
              "item-price": withCtx(({ price }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-medium text-foreground" data-v-fe8e3103${_scopeId2}>Rp ${ssrInterpolate(new Intl.NumberFormat("id-ID").format(price))}</span>`);
                } else {
                  return [
              ...
              "item-status": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col items-center gap-1 py-2" data-v-fe8e3103${_scopeId2}><button${ssrIncludeBooleanAttr(item.availability === "sold") ? " disabled" : ""} class="${ssrRenderClass([[
                  ...
                  ], "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-bold transition-all"])}" data-v-fe8e3103${_scopeId2}>`);
                  ...
                  if (item.status !== "active") {
                    ...
                    }, "text-[9px] font-black uppercase tracking-tighter px-1.5 py-0.5 rounded border"])}" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(item.status === "pending" ? "Moderasi" : item.status === "rejected" ? "Ditolak" : "Dibanned")}</div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
              ...
              "item-created_at": withCtx(({ created_at }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-xs text-muted-foreground" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(new Date(created_at).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }))}</span>`);
                } else {
                  return [
              ...
              "item-actions": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center justify-end gap-2 py-2" data-v-fe8e3103${_scopeId2}>`);
                  if (item.availability !== "sold") {
                    ...
                    _push3(`<div class="text-xs italic text-muted-foreground mr-2 border border-border px-3 py-1.5 rounded-md bg-muted" data-v-fe8e3103${_scopeId2}> Terkunci (Terjual) </div>`);
                  }
                  _push3(`</div>`);
                } else {
                  return [
              ...
              "empty-message": withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-12 text-center text-muted-foreground" data-v-fe8e3103${_scopeId2}><div class="flex flex-col items-center" data-v-fe8e3103${_scopeId2}><span class="mb-2" data-v-fe8e3103${_scopeId2}>Belum ada produk yang dijual.</span>`);
                  _push3(ssrRenderComponent(unref(Link), {
                    href: _ctx.route("products.create"),
            ...
            _push2(`</div><div class="divide-y divide-border md:hidden" data-v-fe8e3103${_scopeId}><!--[-->`);
            ssrRenderList(allMyProducts.value, (item) => {
              var _a3;
              _push2(`<div class="flex flex-col gap-4 p-4" data-v-fe8e3103${_scopeId}><div class="flex items-center gap-4" data-v-fe8e3103${_scopeId}><div class="h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg border border-border bg-muted" data-v-fe8e3103${_scopeId}>`);
              if (item.images && item.images.length > 0) {
                _push2(`<img${ssrRenderAttr("src", `/storage/${item.images[0].image_path}`)} loading="lazy" class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
              } else {
                _push2(`<div class="flex h-full w-full items-center justify-center text-muted-foreground" data-v-fe8e3103${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Image), { class: "h-8 w-8" }, null, _parent2, _scopeId));
                _push2(`</div>`);
              }
              _push2(`</div><div class="min-w-0 flex-1" data-v-fe8e3103${_scopeId}><div class="truncate text-base font-bold" data-v-fe8e3103${_scopeId}>${ssrInterpolate(item.title)}</div><div class="text-xs text-muted-foreground" data-v-fe8e3103${_scopeId}>${ssrInterpolate((_a3 = item.category) == null ? void 0 : _a3.name)}</div><div class="mt-1 font-bold text-primary" data-v-fe8e3103${_scopeId}> Rp ${ssrInterpolate(new Intl.NumberFormat("id-ID").format(item.price))}</div></div></div><div class="flex items-center justify-between gap-4 border-t border-border pt-2" data-v-fe8e3103${_scopeId}><div class="flex flex-col gap-1" data-v-fe8e3103${_scopeId}><button${ssrIncludeBooleanAttr(item.availability === "sold") ? " disabled" : ""} class="${ssrRenderClass([[
                item.availability === "sold" ? "opacity-60 cursor-not-allowed" : "active:scale-90",
                item.availability === "available" ? "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-800/30 dark:bg-emerald-900/20 dark:text-emerald-400" : "border-slate-200 bg-slate-50 text-slate-600 dark:border-slate-700 dark:bg-slate-800/40 dark:text-slate-400"
              ], "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-bold transition-all"])}" data-v-fe8e3103${_scopeId}>`);
              if (item.availability === "available") {
              ...
              if (item.status !== "active") {
                _push2(`<div class="${ssrRenderClass([{
                  ...
                  "border-red-200 bg-red-50 text-red-600": item.status === "rejected",
                  "border-destructive/30 bg-destructive/10 text-destructive": item.status === "banned"
                }, "inline-block text-[8px] font-black uppercase tracking-tighter px-1 rounded border self-start"])}" data-v-fe8e3103${_scopeId}>${ssrInterpolate(item.status === "pending" ? "Moderasi" : item.status === "rejected" ? "Ditolak" : "Dibanned")}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<span class="text-[10px] text-muted-foreground" data-v-fe8e3103${_scopeId}>${ssrInterpolate(new Date(item.created_at).toLocaleDateString("id-ID"))}</span></div><div class="flex items-center gap-2" data-v-fe8e3103${_scopeId}>`);
              if (item.availability !== "sold") {
                _push2(`<!--[-->`);
                _push2(ssrRenderComponent(unref(Link), {
                  href: _ctx.route("products.edit", item.slug),
                ...
                _push2(`<button class="rounded-lg p-2 text-red-500 transition hover:bg-red-500/10" data-v-fe8e3103${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "h-5 w-5" }, null, _parent2, _scopeId));
                _push2(`</button><!--]-->`);
              } else {
                _push2(`<span class="text-[10px] italic text-muted-foreground" data-v-fe8e3103${_scopeId}>Terkunci</span>`);
              }
              _push2(`</div></div></div>`);
            });
            _push2(`<!--]--></div><div class="mt-8 flex justify-center pb-4" data-v-fe8e3103${_scopeId}>`);
            if (loading.value) {
              _push2(`<div class="flex flex-col items-center gap-2" data-v-fe8e3103${_scopeId}><div class="h-6 w-6 animate-spin rounded-full border-2 border-primary border-t-transparent" data-v-fe8e3103${_scopeId}></div><span class="text-[10px] font-bold uppercase tracking-wider text-muted-foreground" data-v-fe8e3103${_scopeId}>Memuat produk...</span></div>`);
            } else if (!nextUrl.value && allMyProducts.value.length > 0) {
              _push2(`<div class="py-4 text-center" data-v-fe8e3103${_scopeId}><span class="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/50" data-v-fe8e3103${_scopeId}>Semua produk ditampilkan</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="transition-all duration-300" style="${ssrRenderStyle(tab.value === "transactions" ? null : { display: "none" })}" data-v-fe8e3103${_scopeId}><div class="border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8" data-v-fe8e3103${_scopeId}><div class="mb-6" data-v-fe8e3103${_scopeId}><h3 class="text-lg font-bold" data-v-fe8e3103${_scopeId}>Pesanan Masuk</h3><p class="text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}>Kelola transaksi penjualan Anda.</p></div><div class="easy-table-wrapper" data-v-fe8e3103${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EasyDataTable, {
              ...
              "item-transaction": withCtx(({ reference_number, product }, _push3, _parent3, _scopeId2) => {
                var _a3, _b3;
                if (_push3) {
                  _push3(`<div class="flex items-center gap-3 py-2" data-v-fe8e3103${_scopeId2}><div class="h-10 w-10 flex-shrink-0 overflow-hidden rounded-md border border-border bg-muted" data-v-fe8e3103${_scopeId2}>`);
                  if (((_a3 = product.images) == null ? void 0 : _a3.length) > 0) {
                    _push3(`<img${ssrRenderAttr("src", `/storage/${product.images[0].image_path}`)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div class="min-w-0" data-v-fe8e3103${_scopeId2}><div class="font-bold truncate text-foreground" data-v-fe8e3103${_scopeId2}>#${ssrInterpolate(reference_number)}</div><div class="text-[10px] text-muted-foreground/80 truncate max-w-[150px]" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(product.title)}</div></div></div>`);
                } else {
                  return [
              ...
              "item-buyer": withCtx(({ buyer }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-2" data-v-fe8e3103${_scopeId2}><div class="text-sm font-medium text-foreground" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(buyer.name)}</div><div class="text-[10px] text-muted-foreground/80" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(buyer.email)}</div></div>`);
                } else {
                  return [
              ...
              "item-total": withCtx(({ price }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-bold text-foreground" data-v-fe8e3103${_scopeId2}>Rp ${ssrInterpolate(new Intl.NumberFormat("id-ID").format(price))}</span>`);
                } else {
                  return [
              ...
              "item-status": withCtx(({ status, payment_method }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col items-start gap-1 py-2" data-v-fe8e3103${_scopeId2}><span class="${ssrRenderClass([{
                  ...
                  }, "px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider rounded-full border"])}" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(getStatusLabel(status))}</span><span class="inline-flex items-center gap-0.5 text-[8px] font-black uppercase text-orange-500" data-v-fe8e3103${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "flex flex-col items-start gap-1 py-2" }, [
                      ...
                      createVNode("span", { class: "inline-flex items-center gap-0.5 text-[8px] font-black uppercase text-orange-500" }, [
              ...
              "item-actions": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-wrap items-center justify-end gap-1.5 py-2" data-v-fe8e3103${_scopeId2}><template data-v-fe8e3103${_scopeId2}>`);
                  if (item.status === "cod_requested") {
                    _push3(`<button class="inline-flex items-center gap-1 px-3 py-1.5 bg-teal-600 text-white text-[10px] font-bold rounded-lg hover:bg-teal-700 transition-colors" data-v-fe8e3103${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Users), { class: "h-3 w-3" }, null, _parent3, _scopeId2));
                    _push3(` Konfirmasi Jadwal </button>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (item.status === "cod_requested") {
                    _push3(`<button class="inline-flex items-center gap-1 px-3 py-1.5 bg-red-50 border border-red-200 text-red-600 text-[10px] font-bold rounded-lg hover:bg-red-100 transition-colors" data-v-fe8e3103${_scopeId2}> Tolak COD </button>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (item.status === "cod_confirmed") {
                    _push3(`<button class="inline-flex items-center gap-1 px-3 py-1.5 bg-orange-500 text-white text-[10px] font-bold rounded-lg hover:bg-orange-600 transition-colors" data-v-fe8e3103${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(CheckCircle2), { class: "h-3 w-3" }, null, _parent3, _scopeId2));
                    _push3(` Tandai Meetup Selesai </button>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (item.status === "cod_meetup_done") {
                    _push3(`<div class="inline-flex items-center gap-1 px-3 py-1.5 bg-orange-50 border border-orange-200 text-orange-600 text-[10px] font-bold rounded-lg" data-v-fe8e3103${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Clock), { class: "h-3 w-3" }, null, _parent3, _scopeId2));
                    _push3(` Menunggu Konfirmasi Buyer </div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</template>`);
                  if (item.status === "disputed") {
                    _push3(`<button class="inline-flex items-center gap-1 text-xs font-bold text-red-500 hover:underline" data-v-fe8e3103${_scopeId2}>`);
                    ...
                    createVNode("div", { class: "flex flex-wrap items-center justify-end gap-1.5 py-2" }, [
                      createVNode("template", null, [
                        item.status === "cod_requested" ? (openBlock(), createBlock("button", {
                          ...
                          createTextVNode(" Konfirmasi Jadwal ")
                        ...
                        item.status === "cod_confirmed" ? (openBlock(), createBlock("button", {
                          key: 2,
                          onClick: ($event) => _ctx.confirm("Konfirmasi bahwa meetup sudah terjadi dan Anda sudah menerima uang dari buyer?") && unref(router).post(_ctx.route("transactions.cod-seller-done", item.id)),
                          ...
                          createTextVNode(" Tandai Meetup Selesai ")
                        ], 8, ["onClick"])) : createCommentVNode("", true),
                        item.status === "cod_meetup_done" ? (openBlock(), createBlock("div", {
                          key: 3,
                          ...
                          createTextVNode(" Menunggu Konfirmasi Buyer ")
              ...
              "empty-message": withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-12 text-center text-muted-foreground" data-v-fe8e3103${_scopeId2}> Belum ada transaksi masuk. </div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="mt-6" data-v-fe8e3103${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              links: __props.transactions.links
            }, null, _parent2, _scopeId));
            _push2(`</div></div></div><div class="transition-all duration-300" style="${ssrRenderStyle(tab.value === "negotiations" ? null : { display: "none" })}" data-v-fe8e3103${_scopeId}><div class="space-y-6" data-v-fe8e3103${_scopeId}><div class="mb-8 flex items-center gap-4" data-v-fe8e3103${_scopeId}><div class="rounded-2xl bg-primary/10 p-3 text-primary" data-v-fe8e3103${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Tag), { class: "h-6 w-6" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-fe8e3103${_scopeId}><h3 class="text-lg font-bold text-foreground" data-v-fe8e3103${_scopeId}>Penawaran Harga dari Buyer</h3><p class="text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}>Terima, counter, atau tolak penawaran yang masuk.</p></div></div>`);
            if (((_b2 = (_a2 = __props.negotiations) == null ? void 0 : _a2.data) == null ? void 0 : _b2.length) === 0) {
              _push2(`<div class="flex flex-col items-center py-24 text-center" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Tag), { class: "mb-4 h-16 w-16 text-muted-foreground/25" }, null, _parent2, _scopeId));
              _push2(`<h4 class="text-lg font-bold text-muted-foreground" data-v-fe8e3103${_scopeId}>Belum ada penawaran masuk</h4><p class="mt-1 text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}>Aktifkan opsi NEGO di produk Anda agar buyer bisa menawar.</p></div>`);
            } else {
              _push2(`<div class="space-y-5" data-v-fe8e3103${_scopeId}><!--[-->`);
              ssrRenderList((_c2 = __props.negotiations) == null ? void 0 : _c2.data, (nego) => {
                var _a3, _b3, _c3, _d3, _e3, _f3, _g3, _h3, _i3, _j3, _k3;
                _push2(`<div class="overflow-hidden rounded-2xl border border-border bg-card shadow-sm" data-v-fe8e3103${_scopeId}><div class="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-muted/20 px-5 py-3" data-v-fe8e3103${_scopeId}><div class="flex items-center gap-3" data-v-fe8e3103${_scopeId}><div class="h-8 w-8 overflow-hidden rounded-full border border-border bg-muted" data-v-fe8e3103${_scopeId}>`);
                if ((_b3 = (_a3 = nego.buyer) == null ? void 0 : _a3.profile) == null ? void 0 : _b3.avatar) {
                  _push2(`<img${ssrRenderAttr("src", `/storage/${nego.buyer.profile.avatar}`)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
                } else {
                  _push2(`<div class="flex h-full w-full items-center justify-center text-xs font-bold text-primary" data-v-fe8e3103${_scopeId}>${ssrInterpolate((_d3 = (_c3 = nego.buyer) == null ? void 0 : _c3.name) == null ? void 0 : _d3.charAt(0))}</div>`);
                }
                _push2(`</div><div data-v-fe8e3103${_scopeId}><p class="text-sm font-bold text-foreground" data-v-fe8e3103${_scopeId}>${ssrInterpolate((_e3 = nego.buyer) == null ? void 0 : _e3.name)}</p><p class="text-[10px] text-muted-foreground" data-v-fe8e3103${_scopeId}>${ssrInterpolate(formatDate(nego.created_at))}</p></div></div><div class="flex items-center gap-2" data-v-fe8e3103${_scopeId}><span class="${ssrRenderClass([badgeClass(nego.status), "rounded-full border px-3 py-1 text-[10px] font-black uppercase tracking-wider"])}" data-v-fe8e3103${_scopeId}>${ssrInterpolate(((_f3 = statusConfig[nego.status]) == null ? void 0 : _f3.label) ?? nego.status)}</span>`);
                if (["pending", "countered"].includes(nego.status)) {
                  _push2(`<span class="flex items-center gap-1 text-[10px] text-muted-foreground" data-v-fe8e3103${_scopeId}>`);
                ...
                _push2(`</div></div><div class="p-5" data-v-fe8e3103${_scopeId}><div class="flex items-center gap-3 mb-4" data-v-fe8e3103${_scopeId}><div class="h-14 w-14 flex-shrink-0 overflow-hidden rounded-xl border border-border bg-muted" data-v-fe8e3103${_scopeId}>`);
                if ((_h3 = (_g3 = nego.product) == null ? void 0 : _g3.images) == null ? void 0 : _h3.length) {
                  _push2(`<img${ssrRenderAttr("src", `/storage/${nego.product.images[0].image_path}`)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
                } else {
                  _push2(`<div class="flex h-full w-full items-center justify-center" data-v-fe8e3103${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(Package), { class: "h-6 w-6 text-muted-foreground/30" }, null, _parent2, _scopeId));
                  _push2(`</div>`);
                }
                _push2(`</div><div data-v-fe8e3103${_scopeId}><p class="font-bold text-foreground truncate max-w-xs" data-v-fe8e3103${_scopeId}>${ssrInterpolate((_i3 = nego.product) == null ? void 0 : _i3.title)}</p><div class="mt-1 flex items-center gap-3 text-sm" data-v-fe8e3103${_scopeId}><span class="text-muted-foreground line-through" data-v-fe8e3103${_scopeId}>${ssrInterpolate(formatRp((_j3 = nego.product) == null ? void 0 : _j3.price))}</span><span class="font-black text-primary" data-v-fe8e3103${_scopeId}>${ssrInterpolate(formatRp(nego.proposed_price))}</span><span class="rounded-full bg-red-100 px-2 py-0.5 text-[9px] font-bold text-red-600 dark:bg-red-900/20 dark:text-red-400" data-v-fe8e3103${_scopeId}> -${ssrInterpolate(Math.round((1 - nego.proposed_price / ((_k3 = nego.product) == null ? void 0 : _k3.price)) * 100))}% </span></div></div></div>`);
                if (nego.message) {
                  _push2(`<div class="mb-4 rounded-xl border border-border bg-muted/30 p-3 text-sm italic text-muted-foreground" data-v-fe8e3103${_scopeId}> &quot;${ssrInterpolate(nego.message)}&quot; </div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (nego.counter_price) {
                  _push2(`<div class="mb-4 rounded-xl border border-indigo-200 bg-indigo-50/50 p-3 text-sm dark:border-indigo-800 dark:bg-indigo-900/10" data-v-fe8e3103${_scopeId}><span class="text-xs font-bold text-indigo-600 dark:text-indigo-400" data-v-fe8e3103${_scopeId}>Counter-offer Anda: </span><span class="font-black text-indigo-700 dark:text-indigo-300" data-v-fe8e3103${_scopeId}>${ssrInterpolate(formatRp(nego.counter_price))}</span>`);
                  if (nego.seller_message) {
                    _push2(`<p class="mt-1 text-xs italic text-muted-foreground" data-v-fe8e3103${_scopeId}>&quot;${ssrInterpolate(nego.seller_message)}&quot;</p>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                ...
                if (["pending", "countered"].includes(nego.status)) {
                  _push2(`<button class="flex w-full items-center justify-center gap-1 rounded-xl border border-border py-2 text-xs font-bold text-muted-foreground hover:bg-muted transition-colors" data-v-fe8e3103${_scopeId}>`);
                ...
                if (expandedItems.value[nego.id] && nego.status === "pending") {
                  _push2(`<div class="mt-4 space-y-4 border-t border-border pt-4" data-v-fe8e3103${_scopeId}><button class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-green-600 py-3 text-sm font-bold text-white shadow-lg shadow-green-600/20 hover:bg-green-700 transition-colors" data-v-fe8e3103${_scopeId}>`);
                  _push2(ssrRenderComponent(unref(CheckCircle2), { class: "h-4 w-4" }, null, _parent2, _scopeId));
                  _push2(` Terima Harga ${ssrInterpolate(formatRp(nego.proposed_price))}</button><div class="rounded-xl border border-indigo-200 bg-indigo-50/50 p-4 dark:border-indigo-800 dark:bg-indigo-900/10" data-v-fe8e3103${_scopeId}><p class="mb-3 text-xs font-black uppercase tracking-widest text-indigo-600 dark:text-indigo-400" data-v-fe8e3103${_scopeId}>Beri Counter-Offer</p><div class="flex gap-2" data-v-fe8e3103${_scopeId}><div class="relative flex-1" data-v-fe8e3103${_scopeId}><span class="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-bold text-muted-foreground" data-v-fe8e3103${_scopeId}>Rp</span><input${ssrRenderAttr("value", getCounterForm(nego.id).counter_price)} type="number" placeholder="Harga counter..." class="w-full rounded-xl border border-border bg-background pl-8 pr-4 py-2.5 text-sm focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-400/20" data-v-fe8e3103${_scopeId}></div><button class="shrink-0 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white hover:bg-indigo-700 transition-colors" data-v-fe8e3103${_scopeId}> Kirim </button></div><input${ssrRenderAttr("value", getCounterForm(nego.id).seller_message)} type="text" placeholder="Pesan untuk buyer (opsional)..." class="mt-2 w-full rounded-xl border border-border bg-background px-3 py-2 text-sm focus:border-indigo-400 focus:outline-none" data-v-fe8e3103${_scopeId}></div><button class="flex w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-red-50/50 py-2.5 text-sm font-bold text-red-600 hover:bg-red-100 transition-colors dark:bg-red-900/10 dark:border-red-800" data-v-fe8e3103${_scopeId}>`);
              ...
              if ((_d2 = __props.negotiations) == null ? void 0 : _d2.links) {
                _push2(`<div class="mt-8" data-v-fe8e3103${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$3, {
            ...
            _push2(`</div></div><div class="transition-all duration-300" style="${ssrRenderStyle(tab.value === "settings" ? null : { display: "none" })}" data-v-fe8e3103${_scopeId}><div class="border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8" data-v-fe8e3103${_scopeId}><div class="max-w-xl" data-v-fe8e3103${_scopeId}><header data-v-fe8e3103${_scopeId}><h2 class="text-lg font-medium" data-v-fe8e3103${_scopeId}>Profil Toko</h2><p class="mt-1 text-sm text-muted-foreground" data-v-fe8e3103${_scopeId}> Informasi ini akan ditampilkan di halaman publik toko Anda. </p></header><form class="mt-6 space-y-6" data-v-fe8e3103${_scopeId}><div class="mb-8 p-1 bg-muted rounded-xl flex gap-1" data-v-fe8e3103${_scopeId}><button type="button" class="${ssrRenderClass([tabSettings.value === "store" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground", "flex-1 py-2 px-4 rounded-lg text-sm font-bold transition-all"])}" data-v-fe8e3103${_scopeId}> Profil Toko </button><button type="button" class="${ssrRenderClass([tabSettings.value === "user" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground", "flex-1 py-2 px-4 rounded-lg text-sm font-bold transition-all"])}" data-v-fe8e3103${_scopeId}> Profil Pribadi </button></div>`);
            if (tabSettings.value === "store") {
              _push2(`<div class="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300" data-v-fe8e3103${_scopeId}><div class="flex flex-col items-center gap-6 border-b border-border pb-6 sm:flex-row sm:items-start" data-v-fe8e3103${_scopeId}><div class="group relative shrink-0" data-v-fe8e3103${_scopeId}><div class="relative h-28 w-28 overflow-hidden rounded-full border-[6px] border-background bg-muted shadow-2xl ring-1 ring-border transition-all duration-300 group-hover:ring-primary" data-v-fe8e3103${_scopeId}>`);
              if (photoPreview.value) {
                _push2(`<img${ssrRenderAttr("src", photoPreview.value)} loading="lazy" class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
              } else if ((_e2 = __props.user.profile) == null ? void 0 : _e2.store_logo) {
                _push2(`<img${ssrRenderAttr("src", `/storage/${__props.user.profile.store_logo}`)} loading="lazy" class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
              } else {
                _push2(`<div class="flex h-full w-full items-center justify-center bg-primary/10 text-4xl font-black text-primary" data-v-fe8e3103${_scopeId}>${ssrInterpolate((((_f2 = __props.user.profile) == null ? void 0 : _f2.store_name) || __props.user.name).substring(0, 1))}</div>`);
              }
              _push2(`<div class="absolute inset-0 flex cursor-pointer flex-col items-center justify-center bg-black/50 opacity-0 backdrop-blur-sm transition-opacity duration-300 group-hover:opacity-100" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Image), { class: "mb-1 h-6 w-6 text-white" }, null, _parent2, _scopeId));
              _push2(`<span class="text-[10px] font-bold uppercase tracking-wider text-white" data-v-fe8e3103${_scopeId}>Ubah Logo</span></div></div><input type="file" class="hidden" accept="image/*" data-v-fe8e3103${_scopeId}><div class="absolute -bottom-1 -right-1 rounded-full bg-background p-1 shadow-sm" data-v-fe8e3103${_scopeId}><button type="button" class="rounded-full bg-primary p-2 text-primary-foreground shadow-sm transition-colors hover:bg-primary/90" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Edit3), { class: "h-4 w-4" }, null, _parent2, _scopeId));
              _push2(`</button></div></div><div class="flex-1 pt-2 text-center sm:text-left" data-v-fe8e3103${_scopeId}><h3 class="text-lg font-black text-foreground" data-v-fe8e3103${_scopeId}>Foto Profil Toko</h3><p class="mb-4 mt-1 text-sm leading-relaxed text-muted-foreground" data-v-fe8e3103${_scopeId}> Rekomendasi rasio 1:1, maks 2MB. Format file JPG, JPEG, PNG, atau WebP. Gambar yang diunggah akan dapat dicrop secara langsung. </p>`);
              ...
              _push2(`</div></div><div class="grid grid-cols-1 gap-6 md:grid-cols-2" data-v-fe8e3103${_scopeId}><div class="md:col-span-2" data-v-fe8e3103${_scopeId}>`);
              ...
              _push2(`</div><div class="md:col-span-2" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                for: "store_bio",
                value: "Bio / Deskripsi Singkat Toko",
                class: "mb-1 font-bold"
              }, null, _parent2, _scopeId));
              _push2(`<textarea id="store_bio" rows="4" class="block w-full resize-none rounded-xl border-border bg-background text-foreground shadow-sm placeholder:text-muted-foreground/60 focus:border-primary focus:ring-primary" placeholder="Ceritakan kelebihan toko Anda kepada calon pembeli..." data-v-fe8e3103${_scopeId}>${ssrInterpolate(unref(storeForm).store_bio)}</textarea>`);
              _push2(ssrRenderComponent(_sfc_main$5, {
            ...
            if (tabSettings.value === "user") {
              ...
              if (personalPhotoPreview.value) {
                _push2(`<img${ssrRenderAttr("src", personalPhotoPreview.value)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
              } else if ((_g2 = __props.user.profile) == null ? void 0 : _g2.avatar) {
                _push2(`<img${ssrRenderAttr("src", `/storage/${__props.user.profile.avatar}`)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId}>`);
              } else {
                _push2(`<div class="flex h-full w-full items-center justify-center bg-primary/10 text-4xl font-black text-primary" data-v-fe8e3103${_scopeId}>${ssrInterpolate(__props.user.name.charAt(0))}</div>`);
              }
              _push2(`<div class="absolute inset-0 flex cursor-pointer flex-col items-center justify-center bg-black/50 opacity-0 backdrop-blur-sm transition-opacity duration-300 group-hover:opacity-100" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Image), { class: "mb-1 h-6 w-6 text-white" }, null, _parent2, _scopeId));
              _push2(`<span class="text-[10px] font-bold uppercase tracking-wider text-white" data-v-fe8e3103${_scopeId}>Ubah Foto</span></div></div><input type="file" class="hidden" accept="image/*" data-v-fe8e3103${_scopeId}></div><div class="flex-1 pt-2 text-center sm:text-left" data-v-fe8e3103${_scopeId}><h3 class="text-lg font-black text-foreground" data-v-fe8e3103${_scopeId}>Foto Profil Pribadi</h3><p class="mb-4 mt-1 text-sm leading-relaxed text-muted-foreground" data-v-fe8e3103${_scopeId}> Foto ini akan muncul saat Anda mengobrol dengan pembeli atau memberikan ulasan. </p>`);
              _push2(ssrRenderComponent(_sfc_main$4, {
              ...
              _push2(`</div><div class="md:col-span-1" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$6, {
                for: "personal_phone",
                value: "Nomor Telepon",
                class: "mb-1 font-bold"
              ...
              _push2(`<div class="relative" data-v-fe8e3103${_scopeId}><div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3" data-v-fe8e3103${_scopeId}>`);
              ...
              _push2(`<select id="gender" class="block h-12 w-full rounded-xl border-border bg-background text-sm focus:border-primary focus:ring-primary" data-v-fe8e3103${_scopeId}><option value="" data-v-fe8e3103${ssrIncludeBooleanAttr(Array.isArray(unref(personalForm).gender) ? ssrLooseContain(unref(personalForm).gender, "") : ssrLooseEqual(unref(personalForm).gender, "")) ? " selected" : ""}${_scopeId}>Pilih Jenis Kelamin</option><option value="male" data-v-fe8e3103${ssrIncludeBooleanAttr(Array.isArray(unref(personalForm).gender) ? ssrLooseContain(unref(personalForm).gender, "male") : ssrLooseEqual(unref(personalForm).gender, "male")) ? " selected" : ""}${_scopeId}>Laki-laki</option><option value="female" data-v-fe8e3103${ssrIncludeBooleanAttr(Array.isArray(unref(personalForm).gender) ? ssrLooseContain(unref(personalForm).gender, "female") : ssrLooseEqual(unref(personalForm).gender, "female")) ? " selected" : ""}${_scopeId}>Perempuan</option><option value="other" data-v-fe8e3103${ssrIncludeBooleanAttr(Array.isArray(unref(personalForm).gender) ? ssrLooseContain(unref(personalForm).gender, "other") : ssrLooseEqual(unref(personalForm).gender, "other")) ? " selected" : ""}${_scopeId}>Lainnya</option></select>`);
              _push2(ssrRenderComponent(_sfc_main$5, {
              ...
              _push2(`<textarea id="personal_bio" rows="3" class="block w-full resize-none rounded-xl border-border bg-background text-foreground shadow-sm focus:border-primary focus:ring-primary" data-v-fe8e3103${_scopeId}>${ssrInterpolate(unref(personalForm).bio)}</textarea></div><div class="md:col-span-2" data-v-fe8e3103${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$8, {
                modelValue: unref(personalForm),
                "onUpdate:modelValue": ($event) => isRef(personalForm) ? personalForm.value = $event : null,
                prefix: ""
              }, null, _parent2, _scopeId));
              _push2(`</div></div><div class="mt-8 flex items-center gap-4 border-t border-border pt-6" data-v-fe8e3103${_scopeId}>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (unref(personalForm).processing) {
                      _push3(`<span class="mr-2 h-5 w-5 animate-spin rounded-full border-2 border-white/30 border-t-white" data-v-fe8e3103${_scopeId2}></span>`);
                    } else {
                      _push3(`<!---->`);
                    }
              ...
              if (unref(personalForm).recentlySuccessful) {
                _push2(`<div class="flex items-center gap-2 rounded-lg border border-green-500/20 bg-green-500/10 px-4 py-2 text-green-600 dark:text-green-400" data-v-fe8e3103${_scopeId}>`);
                _push2(ssrRenderComponent(unref(CheckCircle), { class: "h-4 w-4" }, null, _parent2, _scopeId));
                _push2(`<p class="text-sm font-bold" data-v-fe8e3103${_scopeId}>Profil Pribadi Diperbarui!</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$a, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="bg-card p-6 text-card-foreground" data-v-fe8e3103${_scopeId2}><header class="mb-4" data-v-fe8e3103${_scopeId2}><h2 class="text-xl font-black" data-v-fe8e3103${_scopeId2}>Sesuaikan Foto Profil</h2><p class="mt-1 text-sm text-muted-foreground" data-v-fe8e3103${_scopeId2}> Geser, putar, atau perbesar/perkecil foto untuk mendapatkan potongan yang pas. Lingkaran adalah pratinjau hasil akhirnya. </p></header><div class="relative mb-6 flex aspect-square w-full items-center justify-center overflow-hidden rounded-2xl border-2 border-border bg-black shadow-inner ring-1 ring-border" data-v-fe8e3103${_scopeId2}>`);
                  ...
                  _push3(`</div><div class="mt-6 flex items-center justify-end gap-3" data-v-fe8e3103${_scopeId2}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$a, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a3, _b3;
                if (_push3) {
                  _push3(`<div class="p-6" data-v-fe8e3103${_scopeId2}><div class="flex flex-col items-center justify-center text-center" data-v-fe8e3103${_scopeId2}><div class="mx-auto mb-4 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 dark:bg-red-900" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Trash2), { class: "h-6 w-6 text-red-600 dark:text-red-200" }, null, _parent3, _scopeId2));
                  _push3(`</div><h2 class="text-lg font-medium" data-v-fe8e3103${_scopeId2}>Konfirmasi Hapus</h2><p class="mt-2 text-sm text-muted-foreground" data-v-fe8e3103${_scopeId2}> Apakah Anda yakin ingin menghapus produk <strong data-v-fe8e3103${_scopeId2}>${ssrInterpolate((_a3 = productToDelete.value) == null ? void 0 : _a3.title)}</strong>? <br data-v-fe8e3103${_scopeId2}> Tindakan ini tidak dapat dibatalkan. </p></div><div class="mt-6 flex justify-center gap-3" data-v-fe8e3103${_scopeId2}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$a, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a3, _b3;
                if (_push3) {
                  _push3(`<div class="p-6" data-v-fe8e3103${_scopeId2}><div class="flex items-center justify-between mb-6 border-b border-border pb-4" data-v-fe8e3103${_scopeId2}><h3 class="text-xl font-bold flex items-center gap-2" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(AlertTriangle), { class: "text-red-500 h-6 w-6" }, null, _parent3, _scopeId2));
                  _push3(` Detail Komplain Pembeli </h3><button class="text-muted-foreground hover:text-foreground" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(X), { class: "h-6 w-6" }, null, _parent3, _scopeId2));
                  _push3(`</button></div>`);
                  if (selectedDispute.value) {
                    _push3(`<div class="space-y-6" data-v-fe8e3103${_scopeId2}><div class="bg-muted/50 p-4 rounded-xl border border-border" data-v-fe8e3103${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1" data-v-fe8e3103${_scopeId2}>Alasan</p><p class="text-base font-bold text-foreground" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(selectedDispute.value.reason === "not_delivered" ? "Barang Belum Sampai" : selectedDispute.value.reason === "not_as_described" ? "Barang Tidak Sesuai Deskripsi" : selectedDispute.value.reason === "damaged" ? "Barang Rusak / Cacat" : "Lainnya")}</p></div><div data-v-fe8e3103${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1" data-v-fe8e3103${_scopeId2}>Deskripsi Masalah</p><p class="text-sm leading-relaxed text-foreground whitespace-pre-line" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(selectedDispute.value.description)}</p></div>`);
                    if (((_a3 = selectedDispute.value.evidence_images) == null ? void 0 : _a3.length) > 0) {
                      _push3(`<div data-v-fe8e3103${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3" data-v-fe8e3103${_scopeId2}>Foto Bukti</p><div class="grid grid-cols-2 sm:grid-cols-4 gap-4" data-v-fe8e3103${_scopeId2}><!--[-->`);
                      ssrRenderList(selectedDispute.value.evidence_images, (img, idx) => {
                        _push3(`<a${ssrRenderAttr("href", `/storage/${img}`)} target="_blank" class="aspect-square rounded-xl border border-border overflow-hidden hover:opacity-80 transition-opacity" data-v-fe8e3103${_scopeId2}><img${ssrRenderAttr("src", `/storage/${img}`)} class="h-full w-full object-cover" data-v-fe8e3103${_scopeId2}></a>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-200 dark:border-amber-800" data-v-fe8e3103${_scopeId2}><p class="text-sm text-amber-800 dark:text-amber-300 leading-relaxed font-medium" data-v-fe8e3103${_scopeId2}><strong data-v-fe8e3103${_scopeId2}>Catatan:</strong> Status transaksi telah berubah menjadi <strong data-v-fe8e3103${_scopeId2}>Disputed</strong>. Admin akan meninjau bukti yang ada dan memberikan keputusan segera. Dana Anda tertahan sementara di sistem. </p></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<div class="mt-8 flex justify-end border-t border-border pt-4" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
            ...
            _push2(ssrRenderComponent(_sfc_main$a, {
              show: _ctx.shipModal,
              onClose: ($event) => _ctx.shipModal = false,
              maxWidth: "md"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="p-6" data-v-fe8e3103${_scopeId2}><div class="mb-6 flex items-center justify-between border-b border-border pb-4" data-v-fe8e3103${_scopeId2}><h3 class="flex items-center gap-2 text-lg font-bold" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Truck), { class: "h-5 w-5 text-purple-600" }, null, _parent3, _scopeId2));
                  _push3(` Input Nomor Resi </h3><button class="text-muted-foreground hover:text-foreground" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(X), { class: "h-5 w-5" }, null, _parent3, _scopeId2));
                  _push3(`</button></div><form class="space-y-4" data-v-fe8e3103${_scopeId2}><div data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$6, { value: "Nama Ekspedisi" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$7, {
                    modelValue: _ctx.shipForm.courier_name,
                    "onUpdate:modelValue": ($event) => _ctx.shipForm.courier_name = $event,
                    placeholder: "JNE, J&T, SiCepat, dll.",
                    class: "mt-1 block w-full",
                    required: ""
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$5, {
                    message: _ctx.shipForm.errors.courier_name,
                    class: "mt-1"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$6, { value: "Nomor Resi" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$7, {
                    modelValue: _ctx.shipForm.tracking_number,
                    "onUpdate:modelValue": ($event) => _ctx.shipForm.tracking_number = $event,
                    placeholder: "Masukkan nomor resi...",
                    class: "mt-1 block w-full font-mono",
                    required: ""
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_sfc_main$5, {
                    message: _ctx.shipForm.errors.tracking_number,
                    class: "mt-1"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$6, { value: "Catatan untuk Buyer (opsional)" }, null, _parent3, _scopeId2));
                  _push3(`<textarea rows="2" placeholder="Misal: Barang sudah dikemas rapi, sudah di-bubblewrap..." class="mt-1 block w-full rounded-xl border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(_ctx.shipForm.seller_notes)}</textarea></div><div class="flex justify-end gap-2 pt-2" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    type: "button",
                    onClick: ($event) => _ctx.shipModal = false
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Batal`);
                  ...
                  _push3(ssrRenderComponent(_sfc_main$9, {
                    type: "submit",
                    disabled: _ctx.shipForm.processing
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    createVNode("div", { class: "p-6" }, [
                      ...
                      createVNode("form", {
                        onSubmit: withModifiers(_ctx.submitShipment, ["prevent"]),
                        class: "space-y-4"
                      }, [
                        createVNode("div", null, [
                        ...
                        createVNode("div", null, [
                          ...
                          withDirectives(createVNode("textarea", {
                            "onUpdate:modelValue": ($event) => _ctx.shipForm.seller_notes = $event,
                            rows: "2",
                            ...
                            [vModelText, _ctx.shipForm.seller_notes]
                          ])
                        ]),
            ...
            _push2(ssrRenderComponent(_sfc_main$a, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` Konfirmasi Meetup COD </h3><button class="text-muted-foreground hover:text-foreground" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(X), { class: "h-5 w-5" }, null, _parent3, _scopeId2));
                  _push3(`</button></div><form class="space-y-4" data-v-fe8e3103${_scopeId2}><div data-v-fe8e3103${_scopeId2}>`);
                  ...
                  _push3(`<textarea rows="2" placeholder="Misal: Saya pakai baju merah, hubungi sebelum datang..." class="mt-1 block w-full rounded-xl border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none" data-v-fe8e3103${_scopeId2}>${ssrInterpolate(unref(codForm).seller_notes)}</textarea></div><div class="rounded-xl border border-teal-200 bg-teal-50/50 p-3 text-sm text-teal-700 dark:border-teal-800 dark:bg-teal-900/10 dark:text-teal-300" data-v-fe8e3103${_scopeId2}> ℹ️ Setelah dikonfirmasi, buyer akan menerima notifikasi detail meetup ini. </div><div class="flex justify-end gap-2 pt-2" data-v-fe8e3103${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    type: "button",
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fe8e3103"]]);
export {
