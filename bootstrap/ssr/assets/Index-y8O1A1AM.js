    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4" data-v-a91a508f${_scopeId}><div class="flex items-center gap-3" data-v-a91a508f${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$7, { fallbackRoute: "admin.dashboard" }, null, _parent2, _scopeId));
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground" data-v-a91a508f${_scopeId}> Manajemen Pengguna </h2></div><div class="flex flex-wrap items-center gap-3" data-v-a91a508f${_scopeId}><div class="relative" data-v-a91a508f${_scopeId}>`);
            ...
            _push2(`</div><select class="h-10 rounded-xl border-border bg-card text-sm text-foreground focus:border-primary focus:ring-primary" data-v-a91a508f${_scopeId}><option value="" data-v-a91a508f${ssrIncludeBooleanAttr(Array.isArray(filterRole.value) ? ssrLooseContain(filterRole.value, "") : ssrLooseEqual(filterRole.value, "")) ? " selected" : ""}${_scopeId}>Semua Role</option><option value="buyer" data-v-a91a508f${ssrIncludeBooleanAttr(Array.isArray(filterRole.value) ? ssrLooseContain(filterRole.value, "buyer") : ssrLooseEqual(filterRole.value, "buyer")) ? " selected" : ""}${_scopeId}>Buyer</option><option value="seller" data-v-a91a508f${ssrIncludeBooleanAttr(Array.isArray(filterRole.value) ? ssrLooseContain(filterRole.value, "seller") : ssrLooseEqual(filterRole.value, "seller")) ? " selected" : ""}${_scopeId}>Seller</option><option value="admin" data-v-a91a508f${ssrIncludeBooleanAttr(Array.isArray(filterRole.value) ? ssrLooseContain(filterRole.value, "admin") : ssrLooseEqual(filterRole.value, "admin")) ? " selected" : ""}${_scopeId}>Admin</option></select></div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex flex-col sm:flex-row sm:items-center justify-between gap-4" }, [
                createVNode("div", { class: "flex items-center gap-3" }, [
                  createVNode(_sfc_main$7, { fallbackRoute: "admin.dashboard" }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12" data-v-a91a508f${_scopeId}><div class="mx-auto max-w-7xl sm:px-6 lg:px-8" data-v-a91a508f${_scopeId}><div class="overflow-hidden bg-card border border-border shadow sm:rounded-2xl" data-v-a91a508f${_scopeId}><div class="p-6" data-v-a91a508f${_scopeId}><div class="easy-table-wrapper" data-v-a91a508f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EasyDataTable, {
              ...
              "item-id": withCtx(({ id }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-bold text-muted-foreground/70" data-v-a91a508f${_scopeId2}>#${ssrInterpolate(id)}</span>`);
                } else {
                  return [
              ...
              "item-name": withCtx(({ name, email, profile }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-3 py-2" data-v-a91a508f${_scopeId2}><div class="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center font-bold text-primary flex-shrink-0 overflow-hidden border border-border shadow-sm" data-v-a91a508f${_scopeId2}>`);
                  if (profile == null ? void 0 : profile.avatar) {
                    _push3(`<img${ssrRenderAttr("src", `/storage/${profile.avatar}`)} class="h-full w-full object-cover" data-v-a91a508f${_scopeId2}>`);
                  } else {
                    _push3(`<!--[-->${ssrInterpolate(name.charAt(0))}<!--]-->`);
                  }
                  _push3(`</div><div class="min-w-0" data-v-a91a508f${_scopeId2}><p class="font-bold truncate text-foreground" data-v-a91a508f${_scopeId2}>${ssrInterpolate(name)}</p><p class="text-[10px] text-muted-foreground/80 truncate" data-v-a91a508f${_scopeId2}>${ssrInterpolate(email)}</p></div></div>`);
                } else {
                  return [
              ...
              "item-contact": withCtx(({ email, profile }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col gap-1 text-[10px] py-2 text-muted-foreground" data-v-a91a508f${_scopeId2}><span class="flex items-center gap-1.5" data-v-a91a508f${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Mail), { class: "h-3 w-3 text-primary/70" }, null, _parent3, _scopeId2));
                  _push3(` ${ssrInterpolate(email)}</span><span class="flex items-center gap-1.5" data-v-a91a508f${_scopeId2}>`);
              ...
              "item-role": withCtx(({ role }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-2" data-v-a91a508f${_scopeId2}><span class="text-xs font-black uppercase tracking-widest text-primary" data-v-a91a508f${_scopeId2}>${ssrInterpolate(role)}</span></div>`);
                } else {
                  return [
              ...
              "item-products_count": withCtx(({ products_count }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-2" data-v-a91a508f${_scopeId2}><span class="text-[10px] font-bold text-muted-foreground" data-v-a91a508f${_scopeId2}>${ssrInterpolate(products_count)} Produk</span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "py-2" }, [
              ...
              "item-is_suspended": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (item.is_suspended) {
                    _push3(`<div class="flex flex-col gap-1 py-2" data-v-a91a508f${_scopeId2}><span class="inline-flex items-center gap-1 rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-bold text-red-700 dark:bg-red-900/30 dark:text-red-400" data-v-a91a508f${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(UserX), { class: "h-3 w-3" }, null, _parent3, _scopeId2));
                    _push3(` Suspended </span><p class="text-[9px] text-red-500 max-w-[120px] truncate"${ssrRenderAttr("title", item.suspension_reason)} data-v-a91a508f${_scopeId2}>Ket: ${ssrInterpolate(item.suspension_reason)}</p></div>`);
                  } else {
                    _push3(`<span class="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2 py-0.5 text-[10px] font-bold text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400" data-v-a91a508f${_scopeId2}>`);
              ...
              "item-actions": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex justify-end gap-2 py-2" data-v-a91a508f${_scopeId2}>`);
                  if (!item.is_suspended && item.role !== "admin") {
                    _push3(`<button class="rounded-lg bg-red-500/10 p-2 text-red-600 hover:bg-red-500 hover:text-white transition-all" title="Suspend User" data-v-a91a508f${_scopeId2}>`);
                  ...
                  if (item.is_suspended) {
                    _push3(`<button class="rounded-lg bg-emerald-500/10 p-2 text-emerald-600 hover:bg-emerald-500 hover:text-white transition-all" title="Cabut Suspensi" data-v-a91a508f${_scopeId2}>`);
            ...
            if (__props.users.links.length > 3) {
              _push2(`<div class="mt-6 flex justify-center gap-1" data-v-a91a508f${_scopeId}><!--[-->`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<div class="p-6" data-v-a91a508f${_scopeId2}><h2 class="text-lg font-bold text-foreground" data-v-a91a508f${_scopeId2}> Suspend Pengguna: ${ssrInterpolate((_a = selectedUser.value) == null ? void 0 : _a.name)}</h2><p class="mt-1 text-sm text-muted-foreground" data-v-a91a508f${_scopeId2}> Pengguna yang disuspend tidak akan bisa login ke aplikasi. </p><div class="mt-6" data-v-a91a508f${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    for: "suspension_reason",
                    value: "Alasan Suspensi"
                  }, null, _parent3, _scopeId2));
                  _push3(`<textarea id="suspension_reason" class="mt-1 block w-full rounded-xl border-border bg-background text-sm focus:border-primary focus:ring-primary" rows="3" placeholder="Misal: Pelanggaran syarat &amp; ketentuan, indikasi penipuan, dsb." required data-v-a91a508f${_scopeId2}>${ssrInterpolate(unref(suspendForm).suspension_reason)}</textarea>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    class: "mt-2",
                    message: unref(suspendForm).errors.suspension_reason
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div class="mt-8 flex justify-end gap-3" data-v-a91a508f${_scopeId2}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a91a508f"]]);
export {
  Index as default
};
