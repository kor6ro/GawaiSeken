import { ref, shallowRef, watch, resolveComponent, withCtx, unref, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, withDirectives, vShow, withModifiers, vModelText, Transition, useSSRContext } from "vue";
...
import { LayoutDashboard, ShoppingBag, Settings, Package, MessageCircle, Plus, Image, CheckCircle, Circle, Edit3, Trash2, AlertTriangle, MapPin } from "lucide-vue-next";
...
import { _ as _sfc_main$9 } from "./Modal-C0YBTj_6.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(` Ringkasan </button><button class="${ssrRenderClass([
              tab.value === "transactions" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground",
              "flex flex-1 items-center justify-center gap-1 rounded-lg px-2 py-2 text-xs font-bold transition-all duration-200 sm:gap-2 sm:px-4 sm:py-2.5 sm:text-sm"
            ])}"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(ShoppingBag), { class: "h-4 w-4" }, null, _parent2, _scopeId));
            _push2(` Pesanan </button><button class="${ssrRenderClass([
            ...
            _push2(`</div></div></div><div class="transition-all duration-300" style="${ssrRenderStyle(tab.value === "transactions" ? null : { display: "none" })}"${_scopeId}><div class="border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8"${_scopeId}><div class="mb-6"${_scopeId}><h3 class="text-lg font-bold"${_scopeId}>Pesanan Masuk</h3><p class="text-sm text-muted-foreground"${_scopeId}>Kelola transaksi penjualan Anda.</p></div><div class="overflow-hidden border border-border shadow-sm sm:rounded-lg"${_scopeId}><table class="w-full text-left text-sm"${_scopeId}><thead class="border-b border-border bg-muted text-xs uppercase text-muted-foreground"${_scopeId}><tr${_scopeId}><th scope="col" class="px-6 py-4 font-semibold"${_scopeId}>Transaksi</th><th scope="col" class="px-6 py-4 font-semibold"${_scopeId}>Pembeli</th><th scope="col" class="px-6 py-4 font-semibold"${_scopeId}>Total</th><th scope="col" class="px-6 py-4 text-center font-semibold"${_scopeId}>Status</th><th scope="col" class="px-6 py-4 text-right font-semibold"${_scopeId}>Aksi</th></tr></thead><tbody class="divide-y divide-border"${_scopeId}><!--[-->`);
            ssrRenderList(__props.transactions.data, (order) => {
              var _a3;
              _push2(`<tr class="bg-card transition-colors hover:bg-muted"${_scopeId}><td class="px-6 py-4"${_scopeId}><div class="flex items-center gap-3"${_scopeId}><div class="h-10 w-10 flex-shrink-0 overflow-hidden rounded-md border border-border bg-muted"${_scopeId}>`);
              if (((_a3 = order.product.images) == null ? void 0 : _a3.length) > 0) {
                _push2(`<img${ssrRenderAttr("src", `/storage/${order.product.images[0].image_path}`)} class="h-full w-full object-cover"${_scopeId}>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div${_scopeId}><div class="font-bold"${_scopeId}>#${ssrInterpolate(order.reference_number)}</div><div class="text-[10px] text-muted-foreground truncate max-w-[150px]"${_scopeId}>${ssrInterpolate(order.product.title)}</div></div></div></td><td class="px-6 py-4"${_scopeId}><div class="text-sm font-medium"${_scopeId}>${ssrInterpolate(order.buyer.name)}</div><div class="text-[10px] text-muted-foreground"${_scopeId}>${ssrInterpolate(order.buyer.email)}</div></td><td class="px-6 py-4 font-bold"${_scopeId}> Rp ${ssrInterpolate(new Intl.NumberFormat("id-ID").format(order.price))}</td><td class="px-6 py-4 text-center"${_scopeId}><span class="${ssrRenderClass([{
              ...
              }, "px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider rounded-full border"])}"${_scopeId}>${ssrInterpolate(getStatusLabel(order.status))}</span></td><td class="px-6 py-4 text-right"${_scopeId}><div class="flex items-center justify-end gap-2"${_scopeId}>`);
              if (order.status === "pending") {
                _push2(`<button class="inline-flex items-center gap-1 px-3 py-1 bg-blue-500 text-white text-[10px] font-bold rounded-lg hover:bg-blue-600 transition-colors"${_scopeId}> Tandai Dibayar </button>`);
              } else {
                _push2(`<!---->`);
              }
              if (order.status === "paid") {
                _push2(`<button class="inline-flex items-center gap-1 px-3 py-1 bg-purple-500 text-white text-[10px] font-bold rounded-lg hover:bg-purple-600 transition-colors"${_scopeId}> Tandai Dikirim </button>`);
              } else {
                _push2(`<!---->`);
              }
              if (order.status === "shipped") {
                _push2(`<button class="inline-flex items-center gap-1 px-3 py-1 bg-emerald-500 text-white text-[10px] font-bold rounded-lg hover:bg-emerald-600 transition-colors"${_scopeId}> Selesaikan </button>`);
              } else {
                _push2(`<!---->`);
              }
              if (order.status === "disputed") {
                _push2(`<button class="inline-flex items-center gap-1 text-xs font-bold text-red-500 hover:underline"${_scopeId}>`);
                _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-3 w-3" }, null, _parent2, _scopeId));
                _push2(` Detail Komplain </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td></tr>`);
            ...
            if (__props.transactions.data.length === 0) {
              _push2(`<tr${_scopeId}><td colspan="5" class="px-6 py-12 text-center text-muted-foreground"${_scopeId}> Belum ada transaksi masuk. </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div><div class="mt-6"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$9, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a3, _b3;
                if (_push3) {
                  _push3(`<div class="p-6"${_scopeId2}><div class="flex items-center justify-between mb-6 border-b border-border pb-4"${_scopeId2}><h3 class="text-xl font-bold flex items-center gap-2"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(AlertTriangle), { class: "text-red-500 h-6 w-6" }, null, _parent3, _scopeId2));
                  _push3(` Detail Komplain Pembeli </h3><button class="text-muted-foreground hover:text-foreground"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_X, { class: "h-6 w-6" }, null, _parent3, _scopeId2));
                  _push3(`</button></div>`);
                  if (selectedDispute.value) {
                    _push3(`<div class="space-y-6"${_scopeId2}><div class="bg-muted/50 p-4 rounded-xl border border-border"${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1"${_scopeId2}>Alasan</p><p class="text-base font-bold text-foreground"${_scopeId2}>${ssrInterpolate(selectedDispute.value.reason === "not_delivered" ? "Barang Belum Sampai" : selectedDispute.value.reason === "not_as_described" ? "Barang Tidak Sesuai Deskripsi" : selectedDispute.value.reason === "damaged" ? "Barang Rusak / Cacat" : "Lainnya")}</p></div><div${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1"${_scopeId2}>Deskripsi Masalah</p><p class="text-sm leading-relaxed text-foreground whitespace-pre-line"${_scopeId2}>${ssrInterpolate(selectedDispute.value.description)}</p></div>`);
                    if (((_a3 = selectedDispute.value.evidence_images) == null ? void 0 : _a3.length) > 0) {
                      _push3(`<div${_scopeId2}><p class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3"${_scopeId2}>Foto Bukti</p><div class="grid grid-cols-2 sm:grid-cols-4 gap-4"${_scopeId2}><!--[-->`);
                      ssrRenderList(selectedDispute.value.evidence_images, (img, idx) => {
                        _push3(`<a${ssrRenderAttr("href", `/storage/${img}`)} target="_blank" class="aspect-square rounded-xl border border-border overflow-hidden hover:opacity-80 transition-opacity"${_scopeId2}><img${ssrRenderAttr("src", `/storage/${img}`)} class="h-full w-full object-cover"${_scopeId2}></a>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-200 dark:border-amber-800"${_scopeId2}><p class="text-sm text-amber-800 dark:text-amber-300 leading-relaxed font-medium"${_scopeId2}><strong${_scopeId2}>Catatan:</strong> Status transaksi telah berubah menjadi <strong${_scopeId2}>Disputed</strong>. Admin akan meninjau bukti yang ada dan memberikan keputusan segera. Dana Anda tertahan sementara di sistem. </p></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<div class="mt-8 flex justify-end border-t border-border pt-4"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    ...
                    createVNode("div", { class: "p-6" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-6 border-b border-border pb-4" }, [
                        ...
                        createVNode("button", {
                          ...
                          createVNode(_component_X, { class: "h-6 w-6" })
                        ], 8, ["onClick"])
                      ]),
                    ...
                    createVNode("div", { class: "border border-border bg-card p-4 text-card-foreground shadow-sm sm:rounded-lg sm:p-8" }, [
                      ...
                      createVNode("div", { class: "overflow-hidden border border-border shadow-sm sm:rounded-lg" }, [
                        createVNode("table", { class: "w-full text-left text-sm" }, [
                          ...
                          createVNode("tbody", { class: "divide-y divide-border" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.transactions.data, (order) => {
                              var _a3;
                              return openBlock(), createBlock("tr", {
                                key: order.id,
                                class: "bg-card transition-colors hover:bg-muted"
                                ...
                                createVNode("td", { class: "px-6 py-4" }, [
                                  createVNode("div", { class: "flex items-center gap-3" }, [
                                    createVNode("div", { class: "h-10 w-10 flex-shrink-0 overflow-hidden rounded-md border border-border bg-muted" }, [
                                      ((_a3 = order.product.images) == null ? void 0 : _a3.length) > 0 ? (openBlock(), createBlock("img", {
                                        key: 0,
                                    ...
                                    createVNode("div", null, [
                                      createVNode("div", { class: "font-bold" }, "#" + toDisplayString(order.reference_number), 1),
                                      createVNode("div", { class: "text-[10px] text-muted-foreground truncate max-w-[150px]" }, toDisplayString(order.product.title), 1)
                                    ])
                                  ])
                                ]),
                                createVNode("td", { class: "px-6 py-4" }, [
                                  createVNode("div", { class: "text-sm font-medium" }, toDisplayString(order.buyer.name), 1),
                                  createVNode("div", { class: "text-[10px] text-muted-foreground" }, toDisplayString(order.buyer.email), 1)
                                ]),
                                createVNode("td", { class: "px-6 py-4 font-bold" }, " Rp " + toDisplayString(new Intl.NumberFormat("id-ID").format(order.price)), 1),
                                ...
                                createVNode("td", { class: "px-6 py-4 text-right" }, [
                                  createVNode("div", { class: "flex items-center justify-end gap-2" }, [
                                    order.status === "pending" ? (openBlock(), createBlock("button", {
                                      key: 0,
                                      onClick: ($event) => unref(router).post(_ctx.route("transactions.update-status", order.id), { status: "paid" }),
                                    ...
                                    }, " Tandai Dibayar ", 8, ["onClick"])) : createCommentVNode("", true),
                                    order.status === "paid" ? (openBlock(), createBlock("button", {
                                      key: 1,
                                      onClick: ($event) => unref(router).post(_ctx.route("transactions.update-status", order.id), { status: "shipped" }),
                                    ...
                                    }, " Tandai Dikirim ", 8, ["onClick"])) : createCommentVNode("", true),
                                    order.status === "shipped" ? (openBlock(), createBlock("button", {
                                      key: 2,
                                      onClick: ($event) => unref(router).post(_ctx.route("transactions.update-status", order.id), { status: "completed" }),
                                    ...
                                    }, " Selesaikan ", 8, ["onClick"])) : createCommentVNode("", true),
                                    order.status === "disputed" ? (openBlock(), createBlock("button", {
                                      key: 3,
                                      onClick: ($event) => openDisputeDetail(order),
