...
import { ShoppingCart, Gavel, ShoppingBag, Heart, Package, Trash2, ArrowRight, Calendar, MessageSquare, CheckCircle2, ChevronUp, ChevronDown, MapPin, Users, AlertCircle, XCircle, Truck, RefreshCw, Clock, Info, CreditCard } from "lucide-vue-next";
import "./Pagination-brVOzIHZ.js";
import _sfc_main$2 from "./DisputeForm-DotxPM7z.js";
    ...
    const payNow = async (order) => {
      if (order.snap_token) openSnap(order.snap_token);
        ...
        try {
          ...
          alert("Gagal memperbarui sesi pembayaran.");
        }
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground"${_scopeId}>Aktivitas Saya</h2>`);
          } else {
            return [
              ...
              if (__props.orders.length === 0) {
                ...
                ssrRenderList(__props.orders, (order) => {
                  ...
                  if (order.payment_method === "cod") {
                    _push2(`<span class="inline-flex items-center gap-1 rounded-full bg-orange-100 dark:bg-orange-900/20 px-2 py-0.5 text-[8px] font-black uppercase text-orange-600"${_scopeId}>COD</span>`);
                  } else {
                    _push2(`<span class="inline-flex items-center gap-1 rounded-full bg-blue-100 dark:bg-blue-900/20 px-2 py-0.5 text-[8px] font-black uppercase text-blue-600"${_scopeId}>Rekber</span>`);
                  }
                  _push2(`</div><span class="${ssrRenderClass([badgeClass(getOrderStatus(order.status).color), "rounded-full border px-3 py-1 text-[10px] font-black uppercase tracking-wider"])}"${_scopeId}>${ssrInterpolate(getOrderStatus(order.status).label)}</span></div><div class="p-5"${_scopeId}><div class="flex gap-4"${_scopeId}><div class="h-20 w-20 flex-shrink-0 overflow-hidden rounded-xl border border-border bg-muted"${_scopeId}>`);
                  ...
                  _push2(`<div class="text-xs text-muted-foreground mt-1"${_scopeId}>Seller: ${ssrInterpolate(((_c2 = order.seller.profile) == null ? void 0 : _c2.store_name) || order.seller.name)}</div></div><div class="text-right"${_scopeId}><div class="text-[10px] font-black text-muted-foreground uppercase mb-0.5"${_scopeId}>Total Bayar</div><div class="text-lg font-black text-primary"${_scopeId}>${ssrInterpolate(formatRp(order.total_amount))}</div></div></div></div></div><div class="mt-6 flex items-center gap-3"${_scopeId}>`);
                  if (order.status === "pending" && order.payment_method === "rekber") {
                    _push2(`<button class="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-xs font-bold text-primary-foreground shadow-lg shadow-primary/20 hover:scale-105 transition-all"${_scopeId}>`);
                  ...
                  if (order.status === "shipped") {
                    _push2(`<button class="inline-flex items-center gap-2 rounded-xl bg-green-600 px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-green-600/20 hover:scale-105 transition-all"${_scopeId}>`);
                    _push2(ssrRenderComponent(unref(CheckCircle2), { class: "h-4 w-4" }, null, _parent2, _scopeId));
                    _push2(` Konfirmasi Terima </button>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  ...
                  if (expandedOrders.value[order.id]) {
                    _push2(`<div class="mt-5 pt-5 border-t border-border space-y-4 animate-in slide-in-from-top-2 duration-300"${_scopeId}><div class="grid gap-4 sm:grid-cols-2"${_scopeId}><div class="rounded-xl bg-muted/30 p-4 space-y-2"${_scopeId}><p class="text-[10px] font-black uppercase text-muted-foreground mb-2"${_scopeId}>Rincian Pembayaran</p><div class="flex justify-between text-sm"${_scopeId}><span${_scopeId}>Harga Produk</span><span class="font-bold"${_scopeId}>${ssrInterpolate(formatRp(order.price))}</span></div>`);
                    if (order.service_fee > 0) {
                      _push2(`<div class="flex justify-between text-sm"${_scopeId}><span${_scopeId}>Biaya Layanan</span><span class="font-bold text-amber-600"${_scopeId}>+ ${ssrInterpolate(formatRp(order.service_fee))}</span></div>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`<div class="flex justify-between text-base font-black border-t border-border pt-2 text-primary"${_scopeId}><span${_scopeId}>Total</span><span${_scopeId}>${ssrInterpolate(formatRp(order.total_amount))}</span></div></div>`);
                    if (order.tracking_number) {
                      _push2(`<div class="rounded-xl bg-purple-50 dark:bg-purple-900/10 p-4 border border-purple-100 dark:border-purple-900/30"${_scopeId}><p class="text-[10px] font-black uppercase text-purple-600 mb-2"${_scopeId}>Informasi Pengiriman</p><div class="flex items-center gap-2 text-sm font-bold"${_scopeId}>`);
                      _push2(ssrRenderComponent(unref(Truck), { class: "h-4 w-4" }, null, _parent2, _scopeId));
                      _push2(` ${ssrInterpolate(order.courier_name)}</div><div class="mt-2 text-sm"${_scopeId}><span class="text-muted-foreground"${_scopeId}>Resi:</span><span class="font-mono ml-2 tracking-widest font-bold"${_scopeId}>${ssrInterpolate(order.tracking_number)}</span></div></div>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`</div></div>`);
                              ...
                              createVNode("div", { class: "flex flex-wrap items-center justify-between gap-3 bg-muted/20 px-5 py-3 border-b border-border" }, [
                                createVNode("div", { class: "flex items-center gap-3" }, [
                                  ...
                                  order.payment_method === "cod" ? (openBlock(), createBlock("span", {
                                    key: 0,
                                    class: "inline-flex items-center gap-1 rounded-full bg-orange-100 dark:bg-orange-900/20 px-2 py-0.5 text-[8px] font-black uppercase text-orange-600"
                                  }, "COD")) : (openBlock(), createBlock("span", {
                                    key: 1,
                                    class: "inline-flex items-center gap-1 rounded-full bg-blue-100 dark:bg-blue-900/20 px-2 py-0.5 text-[8px] font-black uppercase text-blue-600"
                                  }, "Rekber"))
                                ]),
                                createVNode("span", {
                                  ...
                                  createVNode("div", { class: "flex-1 min-w-0" }, [
                                    createVNode("div", { class: "flex items-start justify-between gap-4" }, [
                                      ...
                                      createVNode("div", { class: "text-right" }, [
                                        ...
                                        createVNode("div", { class: "text-lg font-black text-primary" }, toDisplayString(formatRp(order.total_amount)), 1)
                                      ])
                                    ])
                                  ])
                                ]),
                                createVNode("div", { class: "mt-6 flex items-center gap-3" }, [
                                  order.status === "pending" && order.payment_method === "rekber" ? (openBlock(), createBlock("button", {
                                    key: 0,
                                    onClick: ($event) => payNow(order),
                                    class: "inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-xs font-bold text-primary-foreground shadow-lg shadow-primary/20 hover:scale-105 transition-all"
                                  }, [
                                  ...
                                  order.status === "shipped" ? (openBlock(), createBlock("button", {
                                    ...
                                    class: "inline-flex items-center gap-2 rounded-xl bg-green-600 px-5 py-2.5 text-xs font-bold text-white shadow-lg shadow-green-600/20 hover:scale-105 transition-all"
                                  }, [
                                    createVNode(unref(CheckCircle2), { class: "h-4 w-4" }),
                                    createTextVNode(" Konfirmasi Terima ")
                                  ], 8, ["onClick"])) : createCommentVNode("", true),
                                  ...
                                  createVNode("div", { class: "grid gap-4 sm:grid-cols-2" }, [
                                    createVNode("div", { class: "rounded-xl bg-muted/30 p-4 space-y-2" }, [
                                      ...
                                      order.service_fee > 0 ? (openBlock(), createBlock("div", {
                                        ...
                                        createVNode("span", null, "Biaya Layanan"),
                                      ...
                                      createVNode("div", { class: "flex justify-between text-base font-black border-t border-border pt-2 text-primary" }, [
                                        ...
                                        createVNode("span", null, toDisplayString(formatRp(order.total_amount)), 1)
                                      ])
                                    ]),
                                    order.tracking_number ? (openBlock(), createBlock("div", {
                                      key: 0,
                                      class: "rounded-xl bg-purple-50 dark:bg-purple-900/10 p-4 border border-purple-100 dark:border-purple-900/30"
                                    }, [
                                      createVNode("p", { class: "text-[10px] font-black uppercase text-purple-600 mb-2" }, "Informasi Pengiriman"),
                                      createVNode("div", { class: "flex items-center gap-2 text-sm font-bold" }, [
                                        createVNode(unref(Truck), { class: "h-4 w-4" }),
                                        createTextVNode(" " + toDisplayString(order.courier_name), 1)
                                      ]),
                                      createVNode("div", { class: "mt-2 text-sm" }, [
                                        createVNode("span", { class: "text-muted-foreground" }, "Resi:"),
                                        createVNode("span", { class: "font-mono ml-2 tracking-widest font-bold" }, toDisplayString(order.tracking_number), 1)
                                      ])
                                    ])) : createCommentVNode("", true)
                                  ])
                                ])) : createCommentVNode("", true)
