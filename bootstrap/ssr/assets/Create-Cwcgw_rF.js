...
import { _ as _sfc_main$2, b as _sfc_main$3, a as _sfc_main$4 } from "./TextInput-ivY_q2i2.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-foreground leading-tight"${_scopeId}> Jual Produk Baru </h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-foreground leading-tight" }, " Jual Produk Baru ")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-7xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="p-4 sm:p-8 bg-card text-card-foreground shadow sm:rounded-2xl border border-border"${_scopeId}><div class="max-w-2xl mx-auto"${_scopeId}><header${_scopeId}><div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold"${_scopeId}>Informasi Produk</h2><p class="mt-1 text-sm text-muted-foreground"${_scopeId}>Lengkapi detail gawai yang ingin Anda jual.</p></div><button type="button" class="inline-flex items-center px-4 py-2 bg-accent text-accent-foreground rounded-xl font-bold text-xs hover:bg-accent/80 transition-all gap-2 border border-border shadow-sm"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(ExternalLink), { class: "w-4 h-4" }, null, _parent2, _scopeId));
            _push2(`<span${_scopeId}>${ssrInterpolate(selectedCategoryName.value.includes("smartphone") || selectedCategoryName.value.includes("tablet") ? "Cari di GSM Arena" : "Cari Spesifikasi")}</span></button></div></header><form class="space-y-8"${_scopeId}><div class="p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300"${_scopeId}><h3 class="text-lg font-bold mb-6 border-b border-border pb-3 flex items-center gap-2"${_scopeId}><span class="flex items-center justify-center w-7 h-7 bg-primary/10 text-primary rounded-full text-xs"${_scopeId}>1</span> 1. Identitas Produk </h3><div class="space-y-6"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "category_id",
              value: "Kategori"
            }, null, _parent2, _scopeId));
            _push2(`<select id="category_id" class="mt-1 block w-full h-11 border-border bg-background text-foreground focus:ring-primary focus:border-primary rounded-xl shadow-sm transition-all" required${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).category_id) ? ssrLooseContain(unref(form).category_id, "") : ssrLooseEqual(unref(form).category_id, "")) ? " selected" : ""}${_scopeId}>-- Pilih Kategori --</option><!--[-->`);
            ...
            _push2(`</div></div></div></div><div class="p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300"${_scopeId}><h3 class="text-lg font-bold mb-6 border-b border-border pb-3 flex items-center gap-2"${_scopeId}><span class="flex items-center justify-center w-7 h-7 bg-primary/10 text-primary rounded-full text-xs"${_scopeId}>2</span> 2. Informasi Penjualan </h3><div class="space-y-6"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "price",
            ...
            _push2(`<p class="mt-1 text-[10px] text-muted-foreground flex items-center gap-1"${_scopeId}>`);
            ...
            _push2(`</div></div></div>`);
            if (showSpecs.value) {
              _push2(`<div class="p-6 sm:p-8 rounded-3xl border border-border bg-primary/5 shadow-sm transition-all duration-300"${_scopeId}><h3 class="text-lg font-bold mb-6 border-b border-border pb-3 flex items-center gap-2"${_scopeId}><span class="flex items-center justify-center w-7 h-7 bg-primary/10 text-primary rounded-full text-xs"${_scopeId}>3</span> 3. Spesifikasi ${ssrInterpolate(selectedCategoryName.value)}</h3><p class="text-xs text-muted-foreground mb-6"${_scopeId}>Informasi spesifikasi membantu calon pembeli mengenal produk lebih dalam.</p><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}>`);
            ...
            _push2(`<div class="p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300"${_scopeId}><h3 class="text-lg font-bold mb-6 border-b border-border pb-3 flex items-center gap-2"${_scopeId}><span class="flex items-center justify-center w-7 h-7 bg-primary/10 text-primary rounded-full text-xs"${_scopeId}>4</span> 4. Media Foto </h3><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "images",
              value: "Upload Foto Produk (Min 1)"
            }, null, _parent2, _scopeId));
            _push2(`<div class="mt-2 flex items-center justify-center w-full"${_scopeId}><label for="images" class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-border rounded-2xl cursor-pointer bg-background hover:bg-muted/50 transition-all group"${_scopeId}><div class="flex flex-col items-center justify-center pt-5 pb-6"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(ImagePlus), { class: "w-10 h-10 text-muted-foreground mb-3 group-hover:scale-110 group-hover:text-primary transition-all" }, null, _parent2, _scopeId));
            _push2(`<p class="text-sm text-muted-foreground"${_scopeId}><span class="font-bold text-primary"${_scopeId}>Klik untuk tambah</span> atau seret ke sini</p><p class="text-[10px] text-muted-foreground mt-1"${_scopeId}>JPG, PNG up to 2MB</p></div><input id="images" type="file" class="hidden" multiple accept="image/jpeg,image/png,image/jpg"${ssrIncludeBooleanAttr(unref(form).images.length === 0) ? " required" : ""}${_scopeId}></label></div>`);
            if (imagePreviews.value.length > 0) {
              _push2(`<div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 mt-6 p-4 bg-muted/50 rounded-2xl border border-border animate-fade-in"${_scopeId}><!--[-->`);
              ssrRenderList(imagePreviews.value, (preview, index) => {
                _push2(`<div class="relative aspect-square rounded-xl overflow-hidden border border-border shadow-sm bg-card group"${_scopeId}><img${ssrRenderAttr("src", preview.url)} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"${_scopeId}><button type="button" class="absolute top-2 right-2 p-1.5 bg-background/90 text-foreground rounded-full flex items-center justify-center shadow-lg border border-border hover:bg-destructive hover:text-white transition-all z-10"${_scopeId}>`);
            ...
            _push2(`<!--]--></div></div><div class="flex items-center gap-6 pt-4 border-t border-border mt-10"${_scopeId}>`);
                  ...
                  createVNode("div", { class: "p-4 sm:p-8 bg-card text-card-foreground shadow sm:rounded-2xl border border-border" }, [
                    createVNode("div", { class: "max-w-2xl mx-auto" }, [
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300" }, [
                        ...
                        createVNode("div", { class: "p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300" }, [
                          ...
                          createVNode("div", { class: "space-y-6" }, [
                            createVNode("div", null, [
                              ...
                              createVNode("p", { class: "mt-1 text-[10px] text-muted-foreground flex items-center gap-1" }, [
                        ...
                        createVNode(Transition, {
                          ...
                          default: withCtx(() => [
                            showSpecs.value ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "p-6 sm:p-8 rounded-3xl border border-border bg-primary/5 shadow-sm transition-all duration-300"
                            }, [
                              createVNode("h3", { class: "text-lg font-bold mb-6 border-b border-border pb-3 flex items-center gap-2" }, [
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground mb-6" }, "Informasi spesifikasi membantu calon pembeli mengenal produk lebih dalam."),
                        ...
                        createVNode("div", { class: "p-6 sm:p-8 rounded-3xl border border-border bg-muted/30 shadow-sm transition-all duration-300" }, [
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("div", { class: "mt-2 flex items-center justify-center w-full" }, [
                              createVNode("label", {
                                for: "images",
                                class: "flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-border rounded-2xl cursor-pointer bg-background hover:bg-muted/50 transition-all group"
                              }, [
                                createVNode("div", { class: "flex flex-col items-center justify-center pt-5 pb-6" }, [
                                  createVNode(unref(ImagePlus), { class: "w-10 h-10 text-muted-foreground mb-3 group-hover:scale-110 group-hover:text-primary transition-all" }),
                                  ...
                                  createVNode("p", { class: "text-[10px] text-muted-foreground mt-1" }, "JPG, PNG up to 2MB")
                                ]),
                                createVNode("input", {
                                  id: "images",
                                  ref_key: "fileInput",
                            ...
                            imagePreviews.value.length > 0 ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 mt-6 p-4 bg-muted/50 rounded-2xl border border-border animate-fade-in"
                            }, [
                              (openBlock(true), createBlock(Fragment, null, renderList(imagePreviews.value, (preview, index) => {
                                return openBlock(), createBlock("div", {
                                  key: index,
                                  class: "relative aspect-square rounded-xl overflow-hidden border border-border shadow-sm bg-card group"
                                }, [
                                  createVNode("img", {
                                    src: preview.url,
                        ...
                        createVNode("div", { class: "flex items-center gap-6 pt-4 border-t border-border mt-10" }, [
