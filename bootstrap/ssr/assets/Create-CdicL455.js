...
import { ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderVNode, ssrInterpolate } from "vue/server-renderer";
import { useForm, Head } from "@inertiajs/vue3";
import { _ as _sfc_main$1 } from "./AppLayout-q3jce_33.js";
import { _ as _sfc_main$7 } from "./PrimaryButton-Chd5xZL9.js";
import { _ as _sfc_main$9 } from "./BackButton-DqmVU1VH.js";
import { Tag, Wrench, CircleDollarSign, Package, Camera, Check, ChevronLeft, ChevronRight } from "lucide-vue-next";
import { _ as _sfc_main$8 } from "./ImageCropperModal-BlmPKPCV.js";
import _sfc_main$2 from "./CategoryStep-DZCDlaR0.js";
import _sfc_main$3 from "./SpecsStep-CRyXc8zG.js";
import { g as getCategoryById, a as getFieldsByCategory, _ as _sfc_main$4 } from "./SalesStep-686x_mPS.js";
import _sfc_main$5 from "./KelengkapanStep-C5yCv2OY.js";
import _sfc_main$6 from "./MediaStep-DkltcEyO.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$9, { fallbackRoute: "dashboard" }, null, _parent2, _scopeId));
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground"${_scopeId}>Jual Produk</h2></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-3" }, [
                createVNode(_sfc_main$9, { fallbackRoute: "dashboard" }),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></ol></nav><div class="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              style: currentStep.value === 0 ? null : { display: "none" },
              form: unref(form),
            ...
            if (currentStep.value > 0) {
              ...
              _push2(`<button type="button" class="text-sm font-bold text-muted-foreground hover:text-destructive"${_scopeId}>Batal</button>`);
            }
              ...
              createVNode("div", { class: "py-8" }, [
                createVNode("div", { class: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" }, [
                  ...
                  createVNode("div", { class: "rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8" }, [
                    ...
                    withDirectives(createVNode(_sfc_main$4, { form: unref(form) }, null, 8, ["form"]), [
                    ...
                    createVNode("div", { class: "mt-8 flex items-center justify-between border-t border-border pt-5" }, [
                      currentStep.value > 0 ? (openBlock(), createBlock("button", {
                        ...
                        class: "text-sm font-bold text-muted-foreground hover:text-destructive"
                      }, "Batal")),
                      createVNode("div", { class: "flex items-center gap-3" }, [
