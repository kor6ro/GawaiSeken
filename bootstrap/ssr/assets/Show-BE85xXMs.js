      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground"${_scopeId}>Profil Toko</h2></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-3" }, [
                createVNode(_sfc_main$2, { fallbackRoute: "home" }),
                createVNode("h2", { class: "text-xl font-semibold leading-tight text-foreground" }, "Profil Toko")
              ])
            ];
          }
        }),
