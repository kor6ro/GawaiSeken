    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4" data-v-6e413295${_scopeId}><h2 class="text-xl font-semibold leading-tight text-foreground" data-v-6e413295${_scopeId}> Manajemen Produk </h2><div class="flex flex-wrap items-center gap-3" data-v-6e413295${_scopeId}><div class="relative" data-v-6e413295${_scopeId}>`);
            ...
            _push2(`</div><select class="h-10 rounded-xl border-border bg-card text-sm text-foreground focus:border-primary focus:ring-primary" data-v-6e413295${_scopeId}><option value="" data-v-6e413295${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "") : ssrLooseEqual(filterStatus.value, "")) ? " selected" : ""}${_scopeId}>Semua Status</option><option value="pending" data-v-6e413295${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "pending") : ssrLooseEqual(filterStatus.value, "pending")) ? " selected" : ""}${_scopeId}>Pending</option><option value="active" data-v-6e413295${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "active") : ssrLooseEqual(filterStatus.value, "active")) ? " selected" : ""}${_scopeId}>Active</option><option value="rejected" data-v-6e413295${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "rejected") : ssrLooseEqual(filterStatus.value, "rejected")) ? " selected" : ""}${_scopeId}>Rejected</option><option value="banned" data-v-6e413295${ssrIncludeBooleanAttr(Array.isArray(filterStatus.value) ? ssrLooseContain(filterStatus.value, "banned") : ssrLooseEqual(filterStatus.value, "banned")) ? " selected" : ""}${_scopeId}>Banned</option></select></div></div>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12" data-v-6e413295${_scopeId}><div class="mx-auto max-w-7xl sm:px-6 lg:px-8" data-v-6e413295${_scopeId}><div class="overflow-hidden bg-card border border-border shadow sm:rounded-2xl" data-v-6e413295${_scopeId}><div class="p-6" data-v-6e413295${_scopeId}><div class="easy-table-wrapper" data-v-6e413295${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EasyDataTable, {
              ...
              "item-id": withCtx(({ id }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-[10px] text-muted-foreground font-bold" data-v-6e413295${_scopeId2}>#${ssrInterpolate(id)}</span>`);
                } else {
                  return [
              ...
              "item-title": withCtx(({ title, price, category, images }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-4 py-2" data-v-6e413295${_scopeId2}><div class="h-12 w-12 flex-shrink-0 overflow-hidden rounded-lg bg-muted border border-border" data-v-6e413295${_scopeId2}>`);
                  if (images.length) {
                    _push3(`<img${ssrRenderAttr("src", "/storage/" + images[0].image_path)} class="h-full w-full object-cover" data-v-6e413295${_scopeId2}>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><div class="min-w-0" data-v-6e413295${_scopeId2}><p class="font-bold text-sm leading-tight line-clamp-1 text-foreground" data-v-6e413295${_scopeId2}>${ssrInterpolate(title)}</p><p class="text-[10px] text-muted-foreground/80 mt-1 truncate" data-v-6e413295${_scopeId2}>Rp ${ssrInterpolate(price.toLocaleString("id-ID"))} | ${ssrInterpolate(category == null ? void 0 : category.name)}</p></div></div>`);
                } else {
                  return [
              ...
              "item-user": withCtx(({ user }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<div class="flex items-center gap-2 py-2" data-v-6e413295${_scopeId2}><div class="h-7 w-7 rounded-full bg-primary/10 flex items-center justify-center text-[10px] font-bold text-primary flex-shrink-0" data-v-6e413295${_scopeId2}>${ssrInterpolate(user.name.charAt(0))}</div><div class="min-w-0" data-v-6e413295${_scopeId2}><p class="text-xs font-medium truncate text-foreground" data-v-6e413295${_scopeId2}>${ssrInterpolate(user.name)}</p><p class="text-[9px] text-muted-foreground/80 truncate" data-v-6e413295${_scopeId2}>${ssrInterpolate(((_a = user.profile) == null ? void 0 : _a.city) || "No City")}</p></div></div>`);
                } else {
                  return [
              ...
              "item-status": withCtx(({ status }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  }, "rounded-full px-2 py-0.5 text-[10px] font-black uppercase tracking-wider"])}" data-v-6e413295${_scopeId2}>${ssrInterpolate(status)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: [{
              ...
              "item-actions": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex justify-end gap-1.5 py-2" data-v-6e413295${_scopeId2}>`);
                  ...
                  if (item.status !== "active") {
                    _push3(`<button class="rounded-lg bg-emerald-500/10 p-2 text-emerald-600 hover:bg-emerald-500 hover:text-white transition-all" title="Setujui (Live)" data-v-6e413295${_scopeId2}>`);
                  ...
                  if (item.status === "pending") {
                    _push3(`<button class="rounded-lg bg-amber-500/10 p-2 text-amber-600 hover:bg-amber-500 hover:text-white transition-all" title="Tolak Produk" data-v-6e413295${_scopeId2}>`);
                  ...
                  if (item.status === "active") {
                    _push3(`<button class="rounded-lg bg-red-500/10 p-2 text-red-600 hover:bg-red-500 hover:text-white transition-all" title="Ban Produk" data-v-6e413295${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Ban), { class: "h-4 w-4" }, null, _parent3, _scopeId2));
                    _push3(`</button>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<button class="rounded-lg bg-red-600/10 p-2 text-red-700 hover:bg-red-700 hover:text-white transition-all" title="Hapus Permanen" data-v-6e413295${_scopeId2}>`);
            ...
            if (__props.products.links.length > 3) {
              _push2(`<div class="mt-6 flex justify-center gap-1" data-v-6e413295${_scopeId}><!--[-->`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<div class="p-6" data-v-6e413295${_scopeId2}><h2 class="text-lg font-bold text-foreground" data-v-6e413295${_scopeId2}>`);
                  if (actionType.value === "delete") {
                  ...
                  _push3(`</h2><p class="mt-1 text-sm text-muted-foreground" data-v-6e413295${_scopeId2}> Produk: <span class="font-semibold text-foreground" data-v-6e413295${_scopeId2}>${ssrInterpolate((_a = selectedProduct.value) == null ? void 0 : _a.title)}</span></p>`);
                  if (actionType.value === "delete") {
                    _push3(`<div class="mt-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-700 text-sm" data-v-6e413295${_scopeId2}><p class="font-bold mb-1" data-v-6e413295${_scopeId2}>Peringatan!</p> Tindakan ini akan menghapus produk dan semua gambarnya secara permanen dari server. Tindakan ini tidak dapat dibatalkan. </div>`);
                  } else if (actionType.value !== "active") {
                    _push3(`<div class="mt-6" data-v-6e413295${_scopeId2}>`);
                    _push3(ssrRenderComponent(_sfc_main$3, {
                      for: "moderation_note",
                      value: "Catatan Moderasi"
                    }, null, _parent3, _scopeId2));
                    _push3(`<textarea id="moderation_note" class="mt-1 block w-full rounded-xl border-border bg-background text-sm focus:border-primary focus:ring-primary" rows="3" placeholder="Berikan alasan agar seller tahu..." required data-v-6e413295${_scopeId2}>${ssrInterpolate(unref(form).moderation_note)}</textarea>`);
                    ...
                    _push3(`<div class="mt-6" data-v-6e413295${_scopeId2}><p class="text-sm text-muted-foreground" data-v-6e413295${_scopeId2}>Apakah Anda yakin ingin menyetujui produk ini agar tayang ke publik?</p></div>`);
                  }
                  _push3(`<div class="mt-8 flex justify-end gap-3" data-v-6e413295${_scopeId2}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6e413295"]]);
export {
  Index as default
};
