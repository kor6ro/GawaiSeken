    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground" data-v-04a18e05${_scopeId}>Pusat Resolusi &amp; Komplain</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12" data-v-04a18e05${_scopeId}><div class="mx-auto max-w-7xl sm:px-6 lg:px-8" data-v-04a18e05${_scopeId}><div class="bg-card border border-border shadow sm:rounded-2xl overflow-hidden" data-v-04a18e05${_scopeId}><div class="p-6" data-v-04a18e05${_scopeId}><div class="flex items-center gap-3 mb-8" data-v-04a18e05${_scopeId}><div class="p-3 rounded-2xl bg-red-100 text-red-600" data-v-04a18e05${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertCircle), { class: "h-6 w-6" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-04a18e05${_scopeId}><h3 class="text-lg font-bold" data-v-04a18e05${_scopeId}>Daftar Komplain Transaksi</h3><p class="text-sm text-muted-foreground" data-v-04a18e05${_scopeId}>Kelola dan selesaikan sengketa antara Buyer &amp; Seller.</p></div></div><div class="easy-table-wrapper" data-v-04a18e05${_scopeId}>`);
            _push2(ssrRenderComponent(_component_EasyDataTable, {
              ...
              "item-transaction": withCtx(({ transaction }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-bold text-foreground" data-v-04a18e05${_scopeId2}>#${ssrInterpolate(transaction.reference_number)}</span>`);
                } else {
                  return [
              ...
              "item-user": withCtx(({ user }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-2" data-v-04a18e05${_scopeId2}><div class="font-medium text-foreground" data-v-04a18e05${_scopeId2}>${ssrInterpolate(user.name)}</div><div class="text-[10px] text-muted-foreground" data-v-04a18e05${_scopeId2}>${ssrInterpolate(user.email)}</div></div>`);
                } else {
                  return [
              ...
              "item-reason": withCtx(({ reason }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-xs font-medium text-foreground" data-v-04a18e05${_scopeId2}>${ssrInterpolate(reason === "not_delivered" ? "Barang Belum Sampai" : reason === "not_as_described" ? "Barang Tidak Sesuai Deskripsi" : reason === "damaged" ? "Barang Rusak / Cacat" : "Lainnya")}</span>`);
                } else {
                  return [
              ...
              "item-status": withCtx(({ status }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass([getStatusClass(status), "px-2 py-0.5 text-[10px] font-black uppercase tracking-wider rounded-full border"])}" data-v-04a18e05${_scopeId2}>${ssrInterpolate(getStatusLabel(status))}</span>`);
                } else {
                  return [
                    createVNode("span", {
              ...
              "item-created_at": withCtx(({ created_at }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="text-muted-foreground" data-v-04a18e05${_scopeId2}>${ssrInterpolate(new Date(created_at).toLocaleDateString("id-ID"))}</span>`);
                } else {
                  return [
              ...
              "item-actions": withCtx((item, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex justify-end py-2" data-v-04a18e05${_scopeId2}>`);
              ...
              "empty-message": withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="py-20 text-center text-muted-foreground" data-v-04a18e05${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Clock), { class: "h-12 w-12 mx-auto mb-4 opacity-20" }, null, _parent3, _scopeId2));
                  _push3(`<p class="font-medium" data-v-04a18e05${_scopeId2}>Tidak ada komplain yang perlu diproses.</p></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div class="mt-8" data-v-04a18e05${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04a18e05"]]);
export {
  Index as default
};
