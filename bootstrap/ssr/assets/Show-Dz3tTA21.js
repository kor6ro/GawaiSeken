...
import { ExternalLink, Globe, ArrowRight, ShieldCheck, MapPin, Store, Edit3, Clock, HandCoins, Users, MessageCircle, Heart, Flag, AlertTriangle, CheckCircle } from "lucide-vue-next";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h2 class="text-xl font-semibold leading-tight text-foreground"${_scopeId}>Detail Produk</h2></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-3" }, [
                createVNode(_sfc_main$3, { fallbackRoute: "home" }),
                createVNode("h2", { class: "text-xl font-semibold leading-tight text-foreground" }, "Detail Produk")
              ])
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if ((_c = (_b = __props.product.store) == null ? void 0 : _b.profile) == null ? void 0 : _c.store_logo) {
              _push2(`<img${ssrRenderAttr("src", `/storage/${__props.product.store.profile.store_logo}`)} class="h-full w-full object-cover"${_scopeId}>`);
            } else {
              _push2(`<span class="text-xl font-black text-primary-foreground"${_scopeId}>${ssrInterpolate((((_e = (_d = __props.product.store) == null ? void 0 : _d.profile) == null ? void 0 : _e.store_name) ?? ((_f = __props.product.store) == null ? void 0 : _f.name)).charAt(0).toUpperCase())}</span>`);
            }
            _push2(`</div>`);
            if (((_h = (_g = __props.product.store) == null ? void 0 : _g.profile) == null ? void 0 : _h.is_ktp_verified) && ((_i = __props.product.store) == null ? void 0 : _i.transactions_as_seller_count) >= 5) {
            ...
            _push2(`</div><div${_scopeId}><div class="flex items-center gap-2"${_scopeId}><h4 class="text-lg font-black"${_scopeId}>${ssrInterpolate(((_k = (_j = __props.product.store) == null ? void 0 : _j.profile) == null ? void 0 : _k.store_name) ?? ((_l = __props.product.store) == null ? void 0 : _l.name))}</h4>`);
            if (((_n = (_m = __props.product.store) == null ? void 0 : _m.profile) == null ? void 0 : _n.is_ktp_verified) && ((_o = __props.product.store) == null ? void 0 : _o.transactions_as_seller_count) >= 5) {
            ...
            _push2(` ${ssrInterpolate(((_q = (_p = __props.product.store) == null ? void 0 : _p.profile) == null ? void 0 : _q.city) || "Lokasi tidak diisi")}</div></div></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("store.show", ((_r = __props.product.store) == null ? void 0 : _r.id) ?? __props.product.user_id),
            ...
            if (isOwner.value) {
              ...
              if (__props.myNegotiation && !hasActiveTransaction.value) {
                ...
                _push2(`<span class="${ssrRenderClass([(_s = negoStatusLabel.value) == null ? void 0 : _s.color, "text-xs font-black uppercase tracking-wider"])}"${_scopeId}>${ssrInterpolate((_t = negoStatusLabel.value) == null ? void 0 : _t.text)}</span></div><div class="text-xs space-y-1"${_scopeId}><p${_scopeId}>Penawaran Anda: <strong${_scopeId}>Rp ${ssrInterpolate(fmt(__props.myNegotiation.proposed_price))}</strong></p>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2, _c2, _d2;
                if (_push3) {
                  _push3(`<div class="bg-card text-card-foreground rounded-2xl p-6"${_scopeId2}><div class="flex items-center gap-3 mb-4"${_scopeId2}><div class="rounded-2xl bg-blue-500/10 p-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Users), { class: "h-6 w-6 text-blue-500" }, null, _parent3, _scopeId2));
                  _push3(`</div><div${_scopeId2}><h3 class="text-xl font-black"${_scopeId2}>Beli via COD</h3><p class="text-xs text-muted-foreground"${_scopeId2}>Ketemu langsung, bayar langsung ke penjual</p></div></div><div class="mb-5 rounded-2xl border-2 border-green-400/40 bg-green-50 dark:bg-green-900/10 px-4 py-3 flex items-center gap-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(CheckCircle), { class: "h-5 w-5 shrink-0 text-green-500" }, null, _parent3, _scopeId2));
                  _push3(`<div${_scopeId2}><p class="text-sm font-black text-green-700 dark:text-green-400"${_scopeId2}>Tanpa Biaya Admin Platform!</p><p class="text-xs text-green-600 dark:text-green-500"${_scopeId2}>COD adalah transaksi langsung antara Anda dan penjual. Tidak ada potongan dari platform.</p></div></div><div class="rounded-2xl bg-muted/50 border border-border p-4 mb-5 space-y-2 text-sm"${_scopeId2}><div class="flex justify-between"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>Harga Produk</span><span class="font-bold"${_scopeId2}>Rp ${ssrInterpolate(fmt(((_a2 = __props.myNegotiation) == null ? void 0 : _a2.status) === "accepted" ? __props.myNegotiation.agreed_price : __props.product.price))}</span></div><div class="flex justify-between"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>Biaya Admin Platform</span><span class="font-black text-green-600"${_scopeId2}>GRATIS ✓</span></div><div class="flex justify-between border-t border-border pt-2"${_scopeId2}><span class="font-bold"${_scopeId2}>Bayar ke Seller Saat Meetup</span><span class="font-black text-orange-600"${_scopeId2}>Rp ${ssrInterpolate(fmt(((_b2 = __props.myNegotiation) == null ? void 0 : _b2.status) === "accepted" ? __props.myNegotiation.agreed_price : __props.product.price))}</span></div></div><div class="mb-5 rounded-xl border border-blue-200 bg-blue-50/50 dark:bg-blue-900/10 dark:border-blue-800 p-4"${_scopeId2}><p class="mb-2 text-[10px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-400"${_scopeId2}>Alur COD (4 Langkah)</p><ol class="space-y-1 text-xs text-muted-foreground"${_scopeId2}><li class="flex items-center gap-2"${_scopeId2}><span class="text-blue-400 font-bold"${_scopeId2}>①</span> Anda kirim permintaan COD + usul lokasi &amp; jadwal</li><li class="flex items-center gap-2"${_scopeId2}><span class="text-blue-400 font-bold"${_scopeId2}>②</span> Penjual setujui atau ubah lokasi &amp; jadwal meetup</li><li class="flex items-center gap-2"${_scopeId2}><span class="text-blue-400 font-bold"${_scopeId2}>③</span> Meetup terjadi → penjual tandai selesai setelah menerima uang</li><li class="flex items-center gap-2"${_scopeId2}><span class="text-blue-400 font-bold"${_scopeId2}>④</span> Anda konfirmasi → transaksi selesai, produk dikunci sebagai <strong${_scopeId2}>Terjual</strong></li></ol></div><form class="space-y-4"${_scopeId2}><div${_scopeId2}><label class="block text-xs font-black uppercase tracking-wider mb-1.5"${_scopeId2}>Usul Lokasi Pertemuan <span class="text-red-500"${_scopeId2}>*</span></label><input${ssrRenderAttr("value", unref(codForm).cod_location)} type="text" required placeholder="Contoh: Alfamart Jl. Sudirman No. 12, Minimarket terdekat..." class="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500/30"${_scopeId2}>`);
                  ...
                  _push3(`<p class="text-[10px] text-muted-foreground mt-1"${_scopeId2}>Penjual dapat mengkonfirmasi atau menyesuaikan lokasi ini.</p></div><div${_scopeId2}><label class="block text-xs font-black uppercase tracking-wider mb-1.5"${_scopeId2}>Usul Jadwal Pertemuan <span class="text-red-500"${_scopeId2}>*</span></label><input${ssrRenderAttr("value", unref(codForm).cod_scheduled_at)} type="datetime-local" required class="w-full rounded-xl border border-border bg-background px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500/30"${_scopeId2}>`);
                  ...
                  _push3(`</div><div class="flex gap-3 pt-1"${_scopeId2}><button type="button" class="flex-1 rounded-xl bg-muted py-3 font-bold text-sm transition hover:bg-muted/80"${_scopeId2}>Batal</button><button type="submit"${ssrIncludeBooleanAttr(unref(codForm).processing) ? " disabled" : ""} class="flex-1 rounded-xl bg-blue-500 py-3 text-sm font-black text-white shadow-lg shadow-blue-500/20 transition hover:bg-blue-600 disabled:opacity-60"${_scopeId2}>${ssrInterpolate(unref(codForm).processing ? "Memproses..." : "Kirim Permintaan COD")}</button></div></form></div>`);
                } else {
                  return [
                    createVNode("div", { class: "bg-card text-card-foreground rounded-2xl p-6" }, [
                      createVNode("div", { class: "flex items-center gap-3 mb-4" }, [
                        createVNode("div", { class: "rounded-2xl bg-blue-500/10 p-3" }, [
                          createVNode(unref(Users), { class: "h-6 w-6 text-blue-500" })
                        ]),
                        createVNode("div", null, [
                          createVNode("h3", { class: "text-xl font-black" }, "Beli via COD"),
                          createVNode("p", { class: "text-xs text-muted-foreground" }, "Ketemu langsung, bayar langsung ke penjual")
                        ])
                      ]),
                      createVNode("div", { class: "mb-5 rounded-2xl border-2 border-green-400/40 bg-green-50 dark:bg-green-900/10 px-4 py-3 flex items-center gap-3" }, [
                        createVNode(unref(CheckCircle), { class: "h-5 w-5 shrink-0 text-green-500" }),
                        createVNode("div", null, [
                          createVNode("p", { class: "text-sm font-black text-green-700 dark:text-green-400" }, "Tanpa Biaya Admin Platform!"),
                          createVNode("p", { class: "text-xs text-green-600 dark:text-green-500" }, "COD adalah transaksi langsung antara Anda dan penjual. Tidak ada potongan dari platform.")
                        ])
                      ]),
                      createVNode("div", { class: "rounded-2xl bg-muted/50 border border-border p-4 mb-5 space-y-2 text-sm" }, [
                        createVNode("div", { class: "flex justify-between" }, [
                          createVNode("span", { class: "text-muted-foreground" }, "Harga Produk"),
                          createVNode("span", { class: "font-bold" }, "Rp " + toDisplayString(fmt(((_c2 = __props.myNegotiation) == null ? void 0 : _c2.status) === "accepted" ? __props.myNegotiation.agreed_price : __props.product.price)), 1)
                        ]),
                        createVNode("div", { class: "flex justify-between" }, [
                          createVNode("span", { class: "text-muted-foreground" }, "Biaya Admin Platform"),
                          createVNode("span", { class: "font-black text-green-600" }, "GRATIS ✓")
                        ]),
                        createVNode("div", { class: "flex justify-between border-t border-border pt-2" }, [
                          ...
                          createVNode("span", { class: "font-black text-orange-600" }, "Rp " + toDisplayString(fmt(((_d2 = __props.myNegotiation) == null ? void 0 : _d2.status) === "accepted" ? __props.myNegotiation.agreed_price : __props.product.price)), 1)
                        ])
                      ]),
                      createVNode("div", { class: "mb-5 rounded-xl border border-blue-200 bg-blue-50/50 dark:bg-blue-900/10 dark:border-blue-800 p-4" }, [
                        createVNode("p", { class: "mb-2 text-[10px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-400" }, "Alur COD (4 Langkah)"),
                        createVNode("ol", { class: "space-y-1 text-xs text-muted-foreground" }, [
                          createVNode("li", { class: "flex items-center gap-2" }, [
                            createVNode("span", { class: "text-blue-400 font-bold" }, "①"),
                            createTextVNode(" Anda kirim permintaan COD + usul lokasi & jadwal")
                          ]),
                          createVNode("li", { class: "flex items-center gap-2" }, [
                            createVNode("span", { class: "text-blue-400 font-bold" }, "②"),
                            createTextVNode(" Penjual setujui atau ubah lokasi & jadwal meetup")
                          ]),
                          createVNode("li", { class: "flex items-center gap-2" }, [
                            createVNode("span", { class: "text-blue-400 font-bold" }, "③"),
                            createTextVNode(" Meetup terjadi → penjual tandai selesai setelah menerima uang")
                          ]),
                          createVNode("li", { class: "flex items-center gap-2" }, [
                            createVNode("span", { class: "text-blue-400 font-bold" }, "④"),
                            createTextVNode(" Anda konfirmasi → transaksi selesai, produk dikunci sebagai "),
                            createVNode("strong", null, "Terjual")
                          ])
                        ])
                      ]),
                      createVNode("form", {
                        ...
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-xs font-black uppercase tracking-wider mb-1.5" }, [
                            createTextVNode("Usul Lokasi Pertemuan "),
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            type: "text",
                            required: "",
                            placeholder: "Contoh: Alfamart Jl. Sudirman No. 12, Minimarket terdekat...",
                          ...
                          createVNode("p", { class: "text-[10px] text-muted-foreground mt-1" }, "Penjual dapat mengkonfirmasi atau menyesuaikan lokasi ini.")
                        ]),
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-xs font-black uppercase tracking-wider mb-1.5" }, [
                            createTextVNode("Usul Jadwal Pertemuan "),
                            createVNode("span", { class: "text-red-500" }, "*")
                          ]),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", { class: "flex gap-3 pt-1" }, [
                          createVNode("button", {
                            type: "button",
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              show: _ctx.showNegoModal,
              onClose: ($event) => _ctx.showNegoModal = false,
              maxWidth: "md"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                    ...
                    createVNode("div", { class: "bg-card text-card-foreground rounded-2xl p-6" }, [
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "flex gap-3" }, [
                          createVNode("button", {
                            type: "button",
                            onClick: ($event) => _ctx.showNegoModal = false,
                            class: "flex-1 rounded-xl bg-muted py-3 font-bold text-sm transition hover:bg-muted/80"
                          }, "Batal", 8, ["onClick"]),
                          createVNode("button", {
                            type: "submit",
                      ...
                      createVNode("div", { class: "sticky top-8 rounded-[2.5rem] border border-border bg-card p-8 text-card-foreground shadow-xl md:p-10" }, [
                        createVNode("div", { class: "mb-8" }, [
                          createVNode("div", { class: "mb-4 flex flex-wrap items-center gap-3" }, [
                            createVNode("span", { class: "rounded-full bg-muted px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-muted-foreground" }, toDisplayString((_u = __props.product.category) == null ? void 0 : _u.name), 1),
                            createVNode("span", {
                              class: [
                                __props.product.condition_badge_color === "green" ? "bg-emerald-500" : __props.product.condition_badge_color === "yellow" ? "bg-amber-500" : "bg-slate-400",
                                "rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-white"
                              ...
                              createVNode("div", { class: "flex items-center gap-4" }, [
                                createVNode("div", { class: "relative" }, [
                                  createVNode("div", { class: "flex h-14 w-14 items-center justify-center rounded-2xl bg-primary overflow-hidden shadow-xl transition-transform group-hover:scale-105" }, [
                                    ((_w = (_v = __props.product.store) == null ? void 0 : _v.profile) == null ? void 0 : _w.store_logo) ? (openBlock(), createBlock("img", {
                                      key: 0,
                                    ...
                                    }, toDisplayString((((_y = (_x = __props.product.store) == null ? void 0 : _x.profile) == null ? void 0 : _y.store_name) ?? ((_z = __props.product.store) == null ? void 0 : _z.name)).charAt(0).toUpperCase()), 1))
                                  ]),
                                  ((_B = (_A = __props.product.store) == null ? void 0 : _A.profile) == null ? void 0 : _B.is_ktp_verified) && ((_C = __props.product.store) == null ? void 0 : _C.transactions_as_seller_count) >= 5 ? (openBlock(), createBlock("div", {
                                    key: 0,
                                ...
                                createVNode("div", null, [
                                  createVNode("div", { class: "flex items-center gap-2" }, [
                                    createVNode("h4", { class: "text-lg font-black" }, toDisplayString(((_E = (_D = __props.product.store) == null ? void 0 : _D.profile) == null ? void 0 : _E.store_name) ?? ((_F = __props.product.store) == null ? void 0 : _F.name)), 1),
                                    ((_H = (_G = __props.product.store) == null ? void 0 : _G.profile) == null ? void 0 : _H.is_ktp_verified) && ((_I = __props.product.store) == null ? void 0 : _I.transactions_as_seller_count) >= 5 ? (openBlock(), createBlock("div", {
                                      key: 0,
                                  ...
                                  createVNode("div", { class: "mt-1 flex items-center text-xs text-muted-foreground" }, [
                                    ...
                                    createTextVNode(" " + toDisplayString(((_K = (_J = __props.product.store) == null ? void 0 : _J.profile) == null ? void 0 : _K.city) || "Lokasi tidak diisi"), 1)
                                  ])
                                ])
                              ]),
                              createVNode(unref(Link), {
                                href: _ctx.route("store.show", ((_L = __props.product.store) == null ? void 0 : _L.id) ?? __props.product.user_id),
                                class: "rounded-xl border border-border bg-card p-3 shadow-sm transition-all hover:bg-accent group-hover:border-primary/30"
                              }, {
                                default: withCtx(() => [
                                  createVNode(unref(Store), { class: "h-5 w-5 transition-transform group-hover:scale-110" })
                            ...
                            isOwner.value ? (openBlock(), createBlock("div", {
                              ...
                              __props.myNegotiation && !hasActiveTransaction.value ? (openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  ...
                                  createVNode("span", {
                                    class: ["text-xs font-black uppercase tracking-wider", (_M = negoStatusLabel.value) == null ? void 0 : _M.color]
                                  }, toDisplayString((_N = negoStatusLabel.value) == null ? void 0 : _N.text), 3)
                                ]),
                              ...
                              !hasActiveTransaction.value ? (openBlock(), createBlock("div", {
                                ...
                                __props.product.is_negotiable && !__props.myNegotiation ? (openBlock(), createBlock("button", {
                                  key: 1,
                                  onClick: ($event) => _ctx.showNegoModal = true,
                  ...
                  return [
                    createVNode("div", { class: "bg-card text-card-foreground rounded-2xl p-6" }, [
                      ...
                      createVNode("div", { class: "rounded-2xl bg-muted/50 border border-border p-4 mb-5 space-y-2 text-sm" }, [
                        ...
                        createVNode("div", { class: "flex justify-between border-t border-border pt-2" }, [
                          createVNode("span", { class: "font-bold" }, "Bayar ke Seller Saat Meetup"),
                          createVNode("span", { class: "font-black text-orange-600" }, "Rp " + toDisplayString(fmt(((_b2 = __props.myNegotiation) == null ? void 0 : _b2.status) === "accepted" ? __props.myNegotiation.agreed_price : __props.product.price)), 1)
                        ])
                      ]),
                      createVNode("div", { class: "mb-5 rounded-xl border border-blue-200 bg-blue-50/50 dark:bg-blue-900/10 dark:border-blue-800 p-4" }, [
                        createVNode("p", { class: "mb-2 text-[10px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-400" }, "Alur COD (4 Langkah)"),
