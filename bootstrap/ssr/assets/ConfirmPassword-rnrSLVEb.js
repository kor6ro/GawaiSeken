      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-4 text-sm text-muted-foreground"${_scopeId}> Ini adalah area aplikasi yang aman. Harap konfirmasi kata sandi Anda sebelum melanjutkan. </div><form${_scopeId}><div${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-4 text-sm text-muted-foreground" }, " Ini adalah area aplikasi yang aman. Harap konfirmasi kata sandi Anda sebelum melanjutkan. "),
              createVNode("form", {
